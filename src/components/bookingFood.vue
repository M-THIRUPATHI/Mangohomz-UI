        ...
        <div class=" lt-sm row justify-center ">
          ...
          >
            <q-card flat class="bg-white;" style="width: 100%">
              <!-- <div
                  class="text-caption text-center text-bold text-red q-pa-sm"
                >
              ...
              >
                <div class="row justify-start">
                  ...
                  >
                    MH BOOKING ID :-
                    {{ foodbookingId.data[0].booking_order_id }}
                  </div>
                  <q-space />
                  <!-- <q-btn flat icon="mdi-arrow-down-drop-circle-outline">
                ...
                <div class="row q-pl-sm">
                  ...
                  >
                    <!-- <strong>{{ this.selected_property_name }} </strong> -->
                    <div class="text-bold text-subtitle">
                      <q-icon size="3em" name="mdi-map-marker-radius" />
                      {{ foodbookingId.data[0].property_city_name }}, India.
                    </div>
                    <div class="text-subtitle" style="font-size: 13px">
                      <q-icon color="secondary" size="3em" name="mdi-city" />
                      Hotel:-
                      {{ foodbookingId.data[0].property_name }}
                    </div>
                    <div class="text-subtitle" style="font-size: 13px">
                      <q-icon
                        color="secondary"
                      ...
                      />
                      Hospital:-
                      {{ foodbookingId.data[0].near_hospital_name }}
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div class="col-4 text-center">
                      ...
                      <div class="text-bold text-subtitle">
                        {{
                          moment(foodbookingId.data[0].check_in).format(
                            "dddd, DD MMM YYYY"
                          )
                        }}
                        <!-- {{ foodbookingId.data[0].check_in }} -->
                      </div>
                      <div class="text-caption">
                        {{
                          moment(foodbookingId.data[0].check_in).format(
                    ...
                    <div class="col-4 text-center">
                      ...
                      <div class="text-bold text-subtitle">
                        {{
                          moment(foodbookingId.data[0].check_out).format(
                            "dddd, DD MMM YYYY"
                          )
                        }}
                        <!-- {{ foodbookingId.data[0].check_out }} -->
                      </div>
                      <div class="text-caption">
                        {{
                          moment(foodbookingId.data[0].check_out).format(
                    ...
                    <div class="col-4 text-center">
                      ...
                      <div class="text-bold text-subtitle">
                        ...
                        {{ this.foodbookingId.data[0].guest_count }} - guest(s)
                      </div>
                      <div class="text-caption">
                        {{ this.foodbookingId.data[0].no_of_days }} Night(s)
                      </div>
                    </div>
                  </div>
                </div>
          ...
          >
            <q-card flat style="height: auto; width: 100%">
              <div class="row items-center">
                <div class="text-h6 text-bold q-pa-sm">Food Partners</div>
                <q-space />
              </div>
              <q-separator v-if="foodbookingId.data[0]" />
              <q-card-actions
                style="display: contents;padding-top: 30px"
                v-if="foodbookingId.data[0]"
              >
                <div
                  class="row text-bold q-pa-sm"
                ...
                >
                  <q-input
                    ...
                    clear-icon="close"
                    minimal
                    ref="SearchFoodPartners"
                    dark
                    v-model="bookingFood.date"
                ...
                >
                  ...
                  <q-btn
                    ...
                    label="Search"
                    color="primary"
                    @click="foodSearch(foodbookingId.data[0].property_city_id)"
                  />
                </div>
              </q-card-actions>
              <!-- <q-card
              flat
              class="bg-white; q-pa-sm bg-red"
              style="padding-top: 0px"
              v-show="this.foodDetails_rows.length > 0"
            >
              <q-separator /> -->
              <q-separator v-if="this.foodDetails_rows.length > 0" />
              <q-card
                flat
              ...
              >
                <div
                  style="margin-top: -63px;justify-content: end; display: inline;"
                  class="q-pa-md row items-start col-12 q-gutter-md"
                  v-if="this.foodDetails_rows.length > 0"
                >
                  <q-card
                    class="item-start col-5 cursor-pointer highlight q-ma-lg"
                    style="
                                width: 334px;
                                height: 150px;
                                background-color: #e4fae9;margin-top: -14px;
                              "
                    :class="class_val"
                    v-for="item in foodDetails_rows"
                        ...
                        <div class="col-4 q-my-auto" style="text-align: center">
                          <q-avatar
                            ...
                            style="
                                    ...
                                    "
                          >
                            {{ item.name_of_kitchen.charAt(0) }}</q-avatar
                          >
                          <!-- <q-icon
                          class="row col-6  q-pa-sm"
                          style="height: 135px;width:100px;border-radius:20px "
                        >
                          {{ item.foodPartner_sub_name.charAt(0) }}
                        </q-icon> -->
                          <!-- <q-img
                          class="row col-12 items-start q-pa-sm"
                          :src="`${foodImgpath}/${item.food_image}`"
                          style="height: 135px;width:100px;border-radius:20px "
                        /> -->
                        </div>
                        ...
                        >
                          ...
                          >
                            ...
                            <q-btn
                              ...
                              outlined
                              filled
                              style="margin-left: 120px; height: 30px"
                              color="primary"
                              @click="onFoodPartner(item)"
                              label="Select"
              ...
              <q-card
                ...
                v-if="this.food_registration_sub_rows.length > 0"
              >
                <div class="row" style="justify-content: center;">
                  <div class="text-h6 text-bold q-pa-sm ">
                    <q-avatar color="secondary" size="30px"
                      >{{ this.foodRows.name_of_kitchen.charAt(0) }}
                    </q-avatar>
                    {{ this.foodRows.name_of_kitchen }}
                  </div>
                </div>
                <div
                  class="q-pa-md row items-start col-12 q-gutter-md"
                ...
                >
                  <q-card
                    ...
                    style="width: 310px; height: 155px; background-color: #e4fae9"
                    :class="class_val"
                    v-for="item in food_registration_sub_rows"
                    :key="item.txn_id"
                  >
                    <span class="q-focus-helper"></span>
                    <q-card-section
                    ...
                    >
                      ...
                      <div class="row">
                        <div class="col-6" style="height: 110px; width: 100px">
                          <q-img
                            class="row  col-6 items-start q-pa-sm"
                            :src="`${foodImgpath}/${item.food_image}`"
                            style="height: 135px; width: 110px; border-radius: 20px; position: relative;"
                           >
                            <!-- <span
                            v-if="this.foodRows.select_offer==='Amount'"
                            style="position: absolute; top: 0; right: 0; background-color:rgb(11, 224, 252); border-radius:40px; padding: 4px;">
                              {{item.enter_amount}}
                            </span>
                            <span
                            v-if="this.foodRows.select_offer==='Percentage'"
                            style="position: absolute; top: 0; right: 0; background-color:rgb(11, 224, 252); border-radius:40px; padding: 4px;">
                              {{this.foodRows.special_offer}}
                            </span> -->
                           </q-img>
                        </div>
                        <div
                          class="col-6 q-ml-md text-center"
                          style="height: 135px; width: 165px; padding-top: 0px"
                        >
                          <div class="row justify-center q-pa-sm">
                            ...
                            >
                              ...
                              <button
                                @click="decreaseCount(item.item_txn_id)"
                                style="display: flex; justify-content:center; align-items:center; margin-left:5px; margin-right:5px; font-weight:800; font-size: 32px; width:30px; color:red; border-radius:3px; border:0px;"
                              >
                                -
                              </button>
                              <span
                                style="font-weight:800; font-size: 14px; text-decoration:underline;"
                                >{{
                                  foodItem.addCount[item.item_txn_id] || 1
                                }}</span
                              >
                              <button
                                v-on:click="increaseCount(item.item_txn_id)"
                                style="display: flex; justify-content:center; align-items:center; margin-left:5px; margin-right:5px; font-weight:800; font-size: 22px; width:22px; color:green; border-radius:3px; border:0px;"
                              >
                                +
                              </button>
                              <span style="font-size: 11px;">PLATES</span>
                            </div>
                          </div>

                          <div class="row text-bold justify-end q-mr-sm">
                            <!-- <q-select dense options-dense class="col-3 text-bold" type="button"
                              v-model="foodItem.addCount[item.item_txn_id]" hide-bottom-space
                              :options="['1', '2', '3', '4', '5']" :rules="[required('Select Item Count')]"
                              @input="loadFoodCount(item)" label="Select No. of Plates"
                              style="width: 90px; height:32px;"
                              >
                              <option v-for="(item, txn_id) in foodItem.item" :key="txn_id"></option>
                            </q-select> -->
                            <q-btn
                              size="sm"
                              outlined
                              ...
                              label="Add"
                              style="margin-left: 10px; width: 40px; height:30px;"
          ...
          <q-card
           ...
           >
            ...
            >
              ...
              >
                <q-list
                 ...
                 >
                  <q-card
                    class="col-11 row q-pa-sm q-ma-sm"
                    :style="{ backgroundColor: item.selected? '#f0f0f0' : '#ffffff' }"
                    type="radio"
                    v-if="
            ...
            <q-separator />
            <q-separator />
            <div class="bg-white" style="max-width: 402px;">
              <div class="row col-12 ">
                <div
                  class="text-caption text-bold q-pa-sm text-silver"
                  style="font-family: verdana; font-size: 12px"
              ...
              >
                <q-item-section class="text-bold text-capitalize"
                  >Selected items</q-item-section
                >
                <q-space />
                <q-item-section class="text-right">
                  {{ this.selectFoodItems }}
                </q-item-section>
              </div>
              ...
              >
                <q-list
                  dense
                  style="font-size: 12px; padding-bottom: 20px;margin-left: 15px;"
                  class="row col-12"
                >
                  <q-item
                    class="col-12"
                    v-for="item in incrementCount"
                    :key="item.item_txn_id"
                  ...
                  >
                    ...
                    >
                      {{ item.food_items_name }} :- ({{ item.price }} *
                    ...
                    <q-item-section
                      class="text-right"
                      style="-webkit-text-stroke-width: thin;margin-right: 5px;"
                      >₹
                  ...
                  >
                    <q-item-section
                      >Base Price :- (for {{ this.getQtyValue }} Qty
                      )</q-item-section
                    ><q-space />
                    <q-item-section
              ...
              >
                ...
                <q-item class="col-12 text-caption text-indigo-9 text-bold" v-if="this.selected_offer_price != 0">
                ...
                <q-item class="col-12 text-caption text-indigo-9 text-bold" v-if="this.partnerOfferPrice!=0">
                  <q-item-section style="-webkit-text-stroke-width: thin;">Restaurant offer</q-item-section
                  ><q-space />
                  <q-item-section
                    class="text-right text-indigo-9"
                    style="-webkit-text-stroke-width: thin;font-size=12px"
                    >(-) ₹{{ this.partnerOfferPrice }}</q-item-section
                  >
                </q-item>
                ...
                <!-- <q-item class="col-12">
                    ...
                    ><q-space />
                    <q-item-section class="text-right"
                      >Rs {{ this.sGstOnPrice }}</q-item-section
                    >
                  </q-item>
                  <q-item class="col-12">
              ...
              >
                <div class="col-2" style="padding-left: 50px">
                  <q-input
                    ...
                    ref="verifyAppNumber"
                    :rules="[required('Whatsapp Number'), phone()]"
        ...
        <q-dialog v-model="privacyPolicyDialog">
          <q-card style="min-width: 350px">
            ...
            <q-card-section>
              ...
              <div
                class="text-bold text-left"
                style="font-family: verdana;font-size: 12px;padding-top: 0px;text-decoration: underline; padding-top: 10px"
              >
              ...
              <div
                class="text-bold text-left"
                style="font-family: verdana;font-size: 12px;padding-top: 0px;text-decoration: underline;"
              >
        ...
        <q-dialog v-model="refundDialog">
          <q-card style="min-width: 350px">
            <q-card-section class="row col-12">
              <div
                class="col-11 text-h6 text-bold text-center text-primary"
                style="font-family: verdana;font-size: 16px;text-decoration: underline;"
              >
        ...
        <q-card style="min-width: 350px">
          ...
          <q-card-section>
            ...
            <div
              style="font-family: verdana; font-size: 12px; padding-top: 10px"
            >
              <strong>MANGOHOMZ (MH)</strong> User can book food 60 Minute
              before but subject to availability. Cancellation is not applicable
              on the same.
            </div>
          </q-card-section>
        </q-card>
      ...
      <div class="justify-center">
        <div class="q-pa-md row justify-center q-gutter-md">
            ...
            <q-card flat class="bg-white;" style="width: 100%">
              ...
              {{ this.selectBookingId }}
                ...
                >
                  ...
                  <div class="row q-mt-sm" style="height: 90px">
                    ...
                    <div
                      class="col-7 q-pa-sm row"
                      style="background-color: #e4fae9;height:90px"
                    >
                      <div class="col-5">
                        <div class="text-caption">
                          <q-icon name="event" class="cursor-pointer"></q-icon
                      ...
                      <div class="col-2">
                        ...
                        <div class="text-bold text-subtitle">
                          <q-icon name="mdi-human-male-female" />
                          {{ this.foodbookingId.data[0].guest_count }} -
                          guest(s)
                        </div>
                        <div class="text-caption">
                          {{ this.foodbookingId.data[0].no_of_days }} Night(s)
          ...
          <q-card style="width: 1000px">
            ...
            <q-card-actions class="row col-12" v-if="foodbookingId.data[0]">
            ...
            >
              <q-card
                class="item-start col-5 highlight q-ma-sm"
                ...
                <div class="row ">
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="col-12 text-caption" style="font-size: 12px">
                        {{ item.type_of_kitchen }}
                      </div>
                      <div class="col-12 text-caption" style="font-size: 11px;">
                        {{ item.location }}
                        <q-btn
                          size="sm"
                          outlined
                          filled
                          style="margin-left: 100px; height: 30px"
                          color="primary"
                          @click="onFoodPartner(item)"
                          label="Select"
                      ...
                      >
                        <div class="row justify-center q-pa-sm">
                          ...
                          >
                            ...
                            <button
                              @click="decreaseCount(item.item_txn_id)"
                              style="display: flex; justify-content:center; align-items:center; margin-left:5px; margin-right:5px; font-weight:800; font-size: 32px; width:30px; color:red; border-radius:3px; border:0px; cursor:pointer;"
                            >
                              -
                            </button>
                            <span
                              style="font-weight:800; font-size: 15px; text-decoration:underline;"
                              >{{
                                foodItem.addCount[item.item_txn_id] || 1
                              }}</span
                            >
                            <button
                              v-on:click="increaseCount(item.item_txn_id)"
                              style="display: flex; justify-content:center; align-items:center; margin-left:5px; margin-right:5px; font-weight:800; font-size: 22px; width:22px; color:green; border-radius:3px; border:0px; cursor:pointer;"
                            >
                              +
                            </button>
                            <span style="font-size: 12px;">PLATES</span>
                          </div>
                        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <!-- <q-item class="col-12">
                    <q-item-section>Food Charges</q-item-section><q-space />
                    <q-item-section class="text-right text-bold" style="font-size=12px">{{ this.foodCharges
                    }}</q-item-section>
                  </q-item>
                  <q-item class="col-12">
                    <q-item-section>Discount (%)</q-item-section><q-space />
                    <q-item-section class="text-right text-secondary text-bold" style="font-size=12px">(-) Rs. {{
                      this.discount }}</q-item-section>
                  </q-item> -->
                  <!-- <q-item class="col-12" style="background-color:#E4FAE9;">
                    <q-item-section>Base Price</q-item-section><q-space />
                    <q-item-section class="text-right text-bold" style="font-size=12px">
                      ₹ {{ this.basicPrice }}
                    </q-item-section>
                  </q-item> -->
                  <q-item class="col-12 text-bold text-indigo-9 text-subtitle2">
                    <q-item-section>MangoHomz Offers</q-item-section><q-space />
                    <q-btn
                      v-if="this.selected_offer_price != 0"
                      flat
                  ...
                  <q-item class="col-12 text-caption text-secondary text-bold" v-if="this.selected_offer_price != 0">
                    <q-item-section>{{
                      this.selected_offer_name
                    }}</q-item-section
                    ><q-space />
                  ...
                  <q-item class="col-12 text-caption text-secondary text-bold" v-if="this.partnerOfferPrice!=0">
                  <q-item-section style="-webkit-text-stroke-width: thin;">Restaurant offer</q-item-section
                  ><q-space />
                  <q-item-section
                  ...
                  <!-- <q-item class="col-12">
                    <q-item-section>CGST on price (9%)</q-item-section><q-space />
                    <q-item-section class="text-right">Rs {{ this.sGstOnPrice }}</q-item-section>
                  </q-item> -->
                  <!-- <q-item class="col-12">
                    <q-item-section>SGST on price (9%)</q-item-section><q-space />
...
export default {
  ...
  data() {
    return {
      ...
      moment: moment,
      popup1: "popup1",
      foodImgpath: filepaths.mhfpFilePath,
      OfferImgpath: "",
      foodbookingId: null,
      ...validations,
      ...
      selectBookingId: "",
      selectFoodItems: "Please Add Food Item Details",
  ...
  created() {
    // this.foodbookingId = "";
    // this.foodbookingId = JSON.parse(this.$route.params.FoodNo);
    // // this.foodbookingId = this.$route.params.FoodNo;
    // this.formDetails.mobile_no = this.foodbookingId.data[0].primary_no;
    // this.formDetails.email_id = this.foodbookingId.data[0].email_id;
    this.$store.state.booking.accBooking_details = [];
    this.$store.state.partners.foodDetails_rows = [];
    this.$store.state.partners.food_registration_sub_rows = [];
    this.incrementCount = [];
  ...
  computed: {
    ...mapState({
      optionsFn(d) {
        ...
        let toDate = date.formatDate(
          this.foodbookingId.data[0].check_out,
          "YYYY/MM/DD"
        );
      ...
      food_registration_sub_rows: state =>
        state.partners.food_registration_sub_rows,
      food_items_add_count: state => state.partners.food_items_add_count,
      accBooking_details: state => state.booking.accBooking_details
      // offers_rows: state => state.partners.offers_rows,
    }),
    getFoodQty() {
    ...
    discount() {
      var discount = "";
      if (this.foodRows.select_offer==="Amount"){
        discount=this.foodRows.enter_amount
      }else if(this.foodRows.select_offer==="Percentage"){
        discount=Math.round(parseFloat(this.getBasePrice).toFixed(2)*parseFloat(this.foodRows.special_offer).toFixed(2)/100);
      }
      return discount;
    },
    basicPrice() {
      var basicPrice =this.incrementCount.reduce((accum, current) => {
        return parseFloat(
          accum + parseInt(current.price) * parseInt(current.add_qty)
        );
      }, 0);
    ...
    priceAfterDiscount() {
      let priceAfterDisc = Math.round(
        parseFloat(this.getBasePrice).toFixed(2) -parseFloat(this.selected_offer_price).toFixed(2)-parseFloat(this.partnerOfferPrice).toFixed(2)
      );
    ...
    partnerOfferPrice() {
      // console.log(this.foodRows,this.getBasePrice);
      let offerPrice=0
      if (this.foodRows.select_offer==="Amount"){
        offerPrice=this.foodRows.enter_amount
      }else if(this.foodRows.select_offer==="Percentage"){
        offerPrice=Math.round(parseFloat(this.getBasePrice).toFixed(2)*parseFloat(this.foodRows.special_offer).toFixed(2)/100);
      }
      return offerPrice
    },
    sGstOnPrice() {
      let sgst = Math.round(
        ((parseFloat(this.basicPrice).toFixed(2) -
          parseFloat(this.selected_offer_price).toFixed(2)-
          parseFloat(this.partnerOfferPrice).toFixed(2)) *
          9) /
          100
      );
      return sgst;
  ...
  async mounted() {
    ...
    let bookingIdRoute = this.$route.params.FoodNo;

    try {
      const data = await this.someFunction(bookingIdRoute);
      this.foodbookingId = data;
    ...
    this.$store.dispatch("booking/getFoodMangohomzOfferData");
    // this.$store.dispatch("booking/getMHBookingData", this.foodbookingId);
  },
  methods: {
    // ...mapActions("booking", ["getMHBookingData"]),
    ...mapActions("booking", ["getFoodMangohomzOfferData"]),
    ...mapActions("partners", ["getBookingFoodDetails"]),
    ...mapActions("partners", ["getBookingFoodTypes"]),
    ...mapActions("partners", ["addFoodItemDetails"]),
    ...mapActions("booking", ["saveFoodBookingLogsDetails"]),
    ...
    incrementItem(item) {
      this.$set(
        this.foodItem.addCount,
        item.item_txn_id,
        this.foodItem.addCount[item.item_txn_id] || 1
      );
      // console.log(item,this.foodArr,this.incrementCount);
      // console.log(this.foodArr);
      // console.log(this.foodItem.addCount);
      // console.log(this.incrementCount);
      this.selectFoodItems = "";
      let isAlreadyExist = false;
      let qtyValue = "";
      this.foodArr = Object.assign({}, item);
      if (this.incrementCount.length > 0) {
        for (const element of this.incrementCount) {
          if (element.item_txn_id == this.foodArr.item_txn_id) {
            isAlreadyExist = true;
        ...
        if (isAlreadyExist) {
          let objIndex = this.incrementCount.findIndex(
            obj => obj.item_txn_id == this.foodArr.item_txn_id
          );
          this.incrementCount[objIndex].add_qty = parseInt(
            this.foodItem.addCount[this.foodArr.item_txn_id]
          );
        } else {
          var incrementObj = {
            account_id: this.foodArr.account_id,
            agent_id: this.foodArr.agent_id,
            agent_sub_id: this.foodArr.agent_sub_id,
            txn_id: this.foodArr.txn_id,
            item_txn_id: this.foodArr.item_txn_id,
            foodPartner_name: this.foodArr.foodPartner_sub_name,
            foodPartner_sub_name: this.foodArr.foodPartner_sub_name,
            kitchen_name: this.foodArr.kitchen_name,
            kitchen_type: this.foodArr.kitchen_type,
            item_name: this.foodArr.item_name,
            food_items_name: this.foodArr.food_items_name,
            price: this.foodArr.price,
            special_offer: this.foodArr.special_offer,
            select_offer: this.foodArr.select_offer,
            enter_amount: this.foodArr.enter_amount,
            location: this.foodArr.location,
            fssai_no: this.foodArr.fssai_no,
            add_qty: this.foodItem.addCount[this.foodArr.item_txn_id]
          };
        ...
        (this.foodArr.account_id = ""),
        (this.foodArr.agent_id = ""),
        (this.foodArr.agent_sub_id = ""),
        (this.foodArr.txn_id = ""),
        (this.foodArr.item_txn_id = ""),
        (this.foodArr.foodPartner_sub_name = ""),
        (this.foodArr.foodPartner_sub_name = ""),
        (this.foodArr.kitchen_name = ""),
        (this.foodArr.kitchen_type = ""),
        (this.foodArr.item_name = ""),
        (this.foodArr.food_items_name = ""),
        (this.foodArr.price = ""),
        (this.foodArr.special_offer = ""),
        (this.foodArr.select_offer = ""),
        (this.foodArr.enter_amount = ""),
        (this.foodArr.location = "");
      this.foodArr.fssai_no = "";
      // (this.foodItem.addCount = 0);
    },
    ...
    increaseCount(txn_id) {
      // Increment the count when the plus button is clicked
      this.$set(
        this.foodItem.addCount,
        txn_id,
        (this.foodItem.addCount[txn_id] || 1) + 1
      );
    },
    decreaseCount(txn_id) {
      // Decrement the count when the minus button is clicked
      const currentCount = this.foodItem.addCount[txn_id] || 1;
      if (currentCount > 1) {
        this.$set(this.foodItem.addCount, txn_id, currentCount - 1);
      }
    },

    selectOffer(item) {
      // console.log(this.mangohomzOffers_arr)
      // let mangohomzOffers_new_arr=this.mangohomzOffers_arr.map((each)=>{
      //   if (each.index===item.index){
      //     return {...each,selected: !each.selected}
      //   }
      //   return each
      // })
      // this.mangohomzOffers_arr=mangohomzOffers_new_arr
      // console.log(mangohomzOffers_new_arr,this.mangohomzOffers_arr)

      // console.log(item)
      // this.active=true

      // if(!this.offer_names_array.includes(item.offer_name)){
      //   this.offer_names_array.push(item.offer_name)
      // }
      // console.log(this.offer_names_array)
    ...
    removeCoupon() {
      ...
      //     color: "red",
      //     position: "top",
      //     message: `The Selected Offer has been Removed!`
      //   });
    },
    ...
    onFoodPartner(item) {
      // console.log(this.foodDetails_rows)
      const index = this.food_registration_sub_rows.indexOf(item);
      this.foodRows = Object.assign({}, item);
      // console.log("this.foodRows", this.foodRows);
      this.getBookingFoodTypes(item);
      this.foodItem.addCount = [];
      this.incrementCount = [];
    },
    foodSearch(item) {
    // console.log("search",item)
      // console.log(parseInt(this.bookingFood.date.slice(0,2)),(new Date()).getDate())
      var foodObj = {
        // item_name: this.bookingFood.item_name,
        date: this.bookingFood.date,
        time: this.bookingFood.time
      };
      if (this.bookingFood.time != "" && this.bookingFood.date != "") {
        this.getBookingFoodDetails(item);
      }else if (this.bookingFood.time == "" || this.bookingFood.date == "") {
        this.$q.notify({
          position: "top",
          color: "negative",
      ...
      if (this.incrementCount.length > 0) {
        if (
          ...
          this.$q
            ...
            .onOk(() => {
              this.guestFoodDetails.booking_id = this.foodbookingId.data[0].booking_id;
              this.guestFoodDetails.booking_order_id = this.foodbookingId.data[0].booking_order_id;
              this.guestFoodDetails.booking_city = this.foodbookingId.data[0].property_city_name;
              this.guestFoodDetails.booking_city_id = this.foodbookingId.data[0].property_city_id;
              this.guestFoodDetails.hotel_property_name = this.foodbookingId.data[0].property_name;
              this.guestFoodDetails.near_hospital_name = this.foodbookingId.data[0].near_hospital_name;
              this.guestFoodDetails.near_hospital_id = this.foodbookingId.data[0].near_hospital_id;
              this.guestFoodDetails.check_in = this.foodbookingId.data[0].check_in;
              this.guestFoodDetails.check_out = this.foodbookingId.data[0].check_out;
              this.guestFoodDetails.guests_count = this.foodbookingId.data[0].guest_count;
              this.guestFoodDetails.no_of_days = this.foodbookingId.data[0].no_of_days;
              this.guestFoodDetails.food_booking_date = this.bookingFood.date;
              this.guestFoodDetails.food_booking_time = this.bookingFood.time;
              // this.guestFoodDetails.food_booking_type = this.bookingFood.item_name;
              this.guestFoodDetails.total_qty_booked = this.getQtyValue;
              this.guestFoodDetails.total_item_qty = this.getFoodQty;
              this.guestFoodDetails.food_charges = this.getBasePrice;
              this.guestFoodDetails.discount_type = this.incrementCount[0].select_offer;
              this.guestFoodDetails.discount_price = this.discount;
              this.guestFoodDetails.base_price = this.basicPrice;
              this.guestFoodDetails.mh_offer_coupon =
                this.selected_offer_name == "" ? "" : this.selected_offer_name;
              this.guestFoodDetails.mh_offer_price = this.selected_offer_price;
              this.guestFoodDetails.price_after_discount = this.priceAfterDiscount;
              this.guestFoodDetails.gst_percentage = 18;
              this.guestFoodDetails.gst_on_base_price = this.gstOnPrice;
              this.guestFoodDetails.cgst_amount = this.cGstOnPrice;
              this.guestFoodDetails.cgst_percentage = 9;
              this.guestFoodDetails.sgst_amount = this.cGstOnPrice;
              this.guestFoodDetails.sgst_percentage = 9;
              this.guestFoodDetails.payable_amount = this.payableAmount;
              this.guestFoodDetails.country_name = this.formDetails.selected_country.name;
              this.guestFoodDetails.country_code = this.formDetails.selected_country.code;
              this.guestFoodDetails.gstin_no = this.formDetails.gstin_no;
              this.guestFoodDetails.mobile_number = this.formDetails.mobile_no;
              this.guestFoodDetails.whatsapp_number = this.formDetails.whatsapp_number;
              this.guestFoodDetails.email_id = this.formDetails.email_id;
              this.guestFoodDetails.selectedFoodObj = this.incrementCount;
              let restaurantOfferPrice=0
              if (this.foodRows.select_offer==="Amount"){
                restaurantOfferPrice=this.foodRows.enter_amount
              }else if(this.foodRows.select_offer==="Percentage"){
                restaurantOfferPrice=Math.round(parseFloat(this.getBasePrice).toFixed(2)*parseFloat(this.foodRows.special_offer).toFixed(2)/100);
              }
              this.guestFoodDetails.restaurantOfferPrice = restaurantOfferPrice;
              let guestFoodData = this.guestFoodDetails;
              this.showRazorpay(guestFoodData);
              // this.$router.push({
              //   name: "FoodData To PaymentPage",
              //   params: { foodbookingdata: guestFoodData }
              // });
            });
        } else {
          this.$q.notify({
        ...
        this.$q.notify({
          color: "negative",
          message: "Please Select Food Items to Continue"
        });
      }
    },
    loadScript(src) {
    ...
    async showRazorpay(item) {
      this.saveFoodBookingLogsDetails(item)
      let paymentObj = {
      ...
      api
        .post("/razorPayPayment/foodPayment", paymentObj)
        .then(response => {
          if (response.status == 200) {
            const options = {
              ...
              handler: response => {
                ...
                this.saveFoodBookingDetails(item);
                // let foodbookingdata=item
                // console.log(foodbookingdata)
                // this.$router.push({ path: '/bookingFoodConfirmedPage', params: { data: JSON.stringify(foodbookingdata) } });
              },
              prefill: {
                name: "Mangohomz",
                email: item.email_id,
    ...
    removeItem(item) {
      const index = this.incrementCount.findIndex(
        i => i.item_txn_id === item.item_txn_id
      );
      if (index !== -1) {
        this.incrementCount.splice(index, 1);
      }
      this.removeCoupon();
      this.$q.notify({
        color: "red",
