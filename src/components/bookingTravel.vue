<template>
  <q-page-container class="bg-gray">
    <headerTag />
    <!--mobile view start-->
    <q-page class="bg-grey lt-sm" style="min-height: 0%">
      <div class="justify-center lt-sm" style="display: flex">
        <div class="lt-sm row justify-center">
          ...
          >
            <div class="row bg-white" style="width: 100%; margin-top: -5px">
              <div
                class="text-h7 text-bold q-pa-sm"
                style="font-size: larger; align-self: end"
              >
                <q-icon size="2em">
                  <q-img
            ...
            <q-card flat class="bg-white;" style="width: 100%">
              ...
              >
                <div class="row justify-start">
                  ...
                  >
                    MH BOOKING ID - {{ bookingId.data[0].booking_order_id }}
                  </div>
                  <q-space />
                </div>
                <q-separator />
                <div class="row q-pl-sm">
                  <div style="margin-top: -4px" class="col-12 col-md-4 q-pa-xs">
                    <div class="text-bold text-subtitle">
                      ...
                      {{ bookingId.data[0].property_name }}
                    </div>
                    <div class="text-subtitle" style="font-size: 13px">
                      <q-icon color="secondary" size="1.5em" name="mdi-city" />
                      {{ bookingId.data[0].property_city_name }}, India.
                    </div>
                    <div class="text-subtitle" style="font-size: 13px">
                      <q-icon
                        color="secondary"
                      ...
                      />
                      Near {{ bookingId.data[0].near_hospital_name }}
                    </div>
                  </div>
                  <div
                    class="col-12 col-md-8 q-pa-sm row"
                    style="width: 378px; background-color: #e4fae9"
                  >
                    <div class="col-4 text-center">
                      ...
                      <div class="text-bold text-subtitle">
                        {{
                          moment(bookingId.data[0].check_in).format(
                            "dddd, DD MMM YYYY"
                          )
                        }}
                      </div>
                      <div class="text-caption">
                        {{
                          moment(bookingId.data[0].check_in).format("h:mm a")
                        }}
                      </div>
                    </div>
                    <div class="col-4 text-center">
                      ...
                      <div class="text-bold text-subtitle">
                        {{
                          moment(bookingId.data[0].check_out).format(
                            "dddd, DD MMM YYYY"
                          )
                        }}
                      </div>
                      <div class="text-caption">
                        {{
                        bookingId !==null &&  moment(bookingId.data[0].check_out).format("h:mm a")
                        }}
                      </div>
                    </div>
                    <div class="col-4 text-center">
                      ...
                      <div class="text-bold text-subtitle">
                        ...
                        {{ bookingId.data[0].guest_count }} - Guest(s)
                      </div>
                      <div class="text-caption">
                        {{ bookingId.data[0].no_of_days }} Night(s)
                      </div>
                    </div>
                  </div>
                </div>
          ...
          >
            <q-card flat style="height: auto; width: 100%">
              <div class="row" style="justify-content: center">
                <div class="text-h6 text-bold q-pa-sm" style="font-size: 14px">
                  Book Your Ride
                </div>
                <q-space />
              </div>
              <q-separator v-if="bookingId.data[0]" />
              <q-card-actions
                style="padding-top: 10px"
                v-if="bookingId.data[0]"
              >
                <div
                  class="row items-start text-bold"
                ...
                >
                        ...
                        >
                          ...
                          >
                            <q-date
                              ...
                              :options="optionsFn"
                              @input="
                                closeDialog(), getdate(bookingTravel.date)
                              "
                            >
                  ...
                  <div>
                    <q-select
                      ...
                      ref="checkorigin"
                      class="text-bold"
                      v-if="firstorigin == true"
                      v-model="bookingTravel.Origin"
                      bg-color="primary"
                      ...
                      filled
                      hide-bottom-space
                      :options="filteredPointTypes"
                      option-label="point_type"
                      option-value="point_type"
                      @input="
                        handleOriginPointTypeChange();
                        emptyPointNames();
                      "
                      label-color="white"
                    ...
                    <q-select
                      ...
                      bg-color="primary"
                      use-input
                      option-label="point_name"
                      option-value="point_name"
                      filled
                      hide-bottom-space
                      label-color="white"
                      color="cyan"
                      v-model="bookingTravel.selectedPointName"
                      label="Location Name"
                  ...
                  <div>
                    <q-select
                      ...
                      outlined
                      dark
                      ref="checksecondorigin"
                      v-if="secondorigin == true"
                      v-model="bookingTravel.Origin1"
                      bg-color="primary"
                      ...
                      filled
                      hide-bottom-space
                      :options="[bookingId.data[0].property_name]"
                      label-color="white"
                      color="cyan"
                      :rules="[required('Pickup Location')]"
                    >
                    </q-select>
                  </div>
                  <div>
                  ...
                  <div>
                    <q-select
                      ...
                      outlined
                      dark
                      v-if="firstdestination == true"
                      v-model="bookingTravel.Destination"
                      bg-color="primary"
                      label="Drop Location *"
                      ref="checkdestination"
                      use-input
                      style="width: 100%; font-size: 12px"
                      filled
                      hide-bottom-space
                  ...
                  <div>
                    <div style="display: flex">
                      <q-select
                        ...
                        dark
                        class="text-bold"
                        v-if="seconddestination == true"
                        v-model="bookingTravel.Destination1"
                        bg-color="primary"
                        label="Drop Location *"
                        aria-checked
                        use-input
                        style="width: 100%; font-size: 12px"
                        filled
                        ref="checkseconddestination"
                        hide-bottom-space
                        :options="filteredPointTypes"
                        option-label="point_type"
                        option-value="point_type"
                        @input="
                          handleOriginPointTypeChange1();
                          emptyPointNames();
                        "
                        label-color="white"
                        color="cyan"
                      ...
                      <q-select
                        style="margin-left: 10px; width: 100%; font-size: 12px"
                        v-if="seconddestination == true"
                        :options="filteredPointNames"
                        dense
                        options-dense
                  ...
                  <div>
                    <q-btn
                      class="col-4 q-mr-sm text-bold justify-end"
                      style="
                        margin-top: 10px;
                        width: 100%;
                        height: 40px;
                      ...
                      label="Search"
                      color="indigo-10"
                      @click="traveldata(bookingId.data[0].property_city_id)"
                    />
                  </div>
                </div>
              </q-card-actions>
              ...
              <q-card
                ...
                v-show="this.travel_item_rows.length > 0"
              >
                <div
                  style="
                    margin-top: -63px;
                  ...
                  v-if="this.travel_item_rows.length > 0"
                >
                  <q-card
                    ...
                    "
                    :class="class_val"
                    v-for="item in travel_item_rows"
                    :key="item.transport_sub_id"
                    @click="travelpartner(item)"
                  >
                    ...
                    <q-card-section
                      ...
                      :active="travel_item_rows"
                      active-class="bg-primary"
                      style="margin-top: 30px"
                    >
                      <!-- <div class="col-6 ">
                      <q-img class="row items-start q-pa-sm" :src="`${travelImgpath}/${item.vehicle_image}`"
                        style="height: 120px; border:1px solid silver;border-radius:5px ; " />
                    </div> -->
                      <div class="row">
                        <div class="col-4 q-my-auto" style="text-align: center">
                          <q-avatar
                            class="text-center"
                            color="secondary"
                            size="6em"
                          ...
                          >
                            {{
                              item.transport_company_name.charAt(0)
                            }}</q-avatar
                          >
                        </div>

                        <div
                          class="col-6 q-ml-md text-center"
                          style="height: 135px; padding-top: 0px"
                        >
                          ...
                          <!-- <div
                            class="text-caption col-12"
                            style="font-size: 12px"
                          >
                            {{ item.transport_sub_name }}
                          </div> -->
                          <div
                            class="text-primary text-caption col-12"
                            style="font-size: 12px"
                          >
                            {{ item.city }}
                          </div>
                          <q-btn
                            ...
                            outlined
                            filled
                            style="margin-left: 80px; height: 30px"
                            color="primary"
                            @click="travelpartner(item)"
                            label="Select"
                            class="text-weight-bold justify-end q-mt-sm"
                          />
                        </div>
                        <!-- </div> -->
                      </div>
              ...
              <q-card
                ...
                v-if="this.sub_travel_item_rows.length > 0"
              >
                <div class="row" style="justify-content: center">
                  <!-- <q-icon size="2em">
                    <q-img class="row items-start q-pa-sm" :src="`${travelImgpath}/${this.travelRows.vehicle_image}`"
                      style="border-radius: 10px;" />
                  </q-icon> -->

                  <div class="text-h6 text-bold q-pa-sm">
                    <q-avatar color="secondary" size="30px"
                      >{{ this.travelRows.transport_company_name.charAt(0) }}
                    </q-avatar>
                    {{ this.travelRows.transport_company_name }}
                  </div>
                </div>
                ...
                >
                  <q-card
                    class="item-start col-3 cursor-pointer q-ma-sm"
                    :class="class_val"
                    style="width: 300px"
                    v-for="item in sub_travel_item_rows"
                    :key="item.txn_id"
                  >
                    <q-card-section
                      horizontal
                    ...
                    >
                      <div class="col-6 q-mt-md">
                        <!-- <div class="col-6 q-mt-xl q-ml-md "> -->
                        <q-img
                          class="row items-start q-pa-sm"
                          :src="`${travelImgpath}/${item.vehicle_image}`"
                          style="
                            height: 140px;
                      ...
                      <div style="margin-top: 25px" class="col-6 q-ml-xs">
                        <div class="col-6 q-pa-sm">
                          <div
                            class="text-capitalize text-black text-bold q-mb-lg"
                          ...
                          >
                            {{ bookingId.data[0].property_name }} is
                            {{ bookingTravel.selectedPointName.kiloMeter }} KM
                            from
                            {{ bookingTravel.selectedPointName.point_name }}
                          </span>
                          <div class="text-caption">
                            <q-icon name="mdi-currency-inr" color="secondary" />
                            Rs.{{ item.price }}
                          </div>
                          <!-- <q-icon color="green" size="1.5em" name="mdi-cash-multiple" /> -->
                        ...
                        <!-- <div
                        class="row text-bold justify-end q-mr-lg"
                        style="font-size: 12px"
                      >
                        {{ Number(item.special_offer).toFixed(0) }}% Off
                      </div> -->
                        <div class="row text-caption q-pl-xl">
                          <q-btn
                            size="sm"
                            outlined
                            filled
                            color="primary"
                            class="text-weight-bold justify-end q-ml-lg"
                            @click="cartdetails(item)"
                            >Add+
                          </q-btn>
                        </div>
                      </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <q-card
                    v-if="
                      travelCharges >= item.offer_money_start &&
                      travelCharges <= item.offer_money_end
                    "
                  ...
                  >
                    <div class="row">
                      <q-img
                        :src="`${hotelImgpath}${item.offer_image}`"
            ...
            <div class="bg-white" style="max-width: 402px; height: 450px">
              ...
              <div
                ...
                ref="cardetails"
              >
                <q-list dense style="font-size: 11px" class="row col-12">
                  <q-item class="col-12">
                    <q-item-section class="text-bold text-capitalize"
                      >Selected Vehicle</q-item-section
                    >
                    <q-space />
                    <q-item-section class="text-right">
                      {{ this.travelcartRows.vehicle_name }}
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item
                    ...
                    style="background-color: #e4fae9"
                  >
                    <q-item-section>Base Price</q-item-section>
                    <q-space />
                    <q-item-section class="text-right">
                      <span v-if="this.travelcartRows.units === 'Per/Km'">
                        ₹ {{ basePrice }} /-
                      </span>
                      <span
                        v-else-if="this.travelcartRows.units === 'Per/Trip'"
                      >
                        ₹ {{ travelcartRows.price }} /-
                      </span>
                    </q-item-section>
                  </q-item>
                </q-list>
              ...
              >
                ...
                >
                  <q-item-section>MangoHomz Offers</q-item-section>
                  <q-space />
                  <q-btn
                ...
                <q-item class="col-12 text-caption text-indigo-9 text-bold">
                  <q-item-section>
                    {{ this.selected_offer_name }}/-</q-item-section
                  >
                  <q-space />
                  <q-item-section class="text-right text-indigo-9"
                ...
                <q-item
                  class="col-12 text-bold"
                  style="-webkit-text-stroke: thin; background-color: #e4fae9"
                >
                  <q-item-section>Price after discount</q-item-section>
                  <q-space />
                  <q-item-section class="text-right">
                    ₹ {{ this.priceAfterDiscount }}/-</q-item-section
                  >
                </q-item>
                <q-item class="col-12" style="-webkit-text-stroke: thin">
                ...
                <q-item class="col-12 text-bold">
                  <q-item-section>Taxes</q-item-section>
                  <q-item-section class="text-right"
                    >₹ {{ parseInt(this.gstOnPrice) }}
                  </q-item-section>
                  <q-space />
                </q-item>
                <q-item class="col-12">
                  <q-item-section class="text-bold text-indigo-9"
                    >Convenience Fee</q-item-section
                  >
                  <q-space />
                  <q-item-section class="text-right text-bold text-indigo-9"
                    >₹0
                    <!-- {{ this.cGstOnPrice }} -->
                  </q-item-section>
                </q-item>
                <!-- <q-item class="col-12">
                    ...
                    <q-space />
                    <q-item-section class="text-right"
                      >Rs {{ this.cgstOnPrice }}/-</q-item-section
                    >
                  </q-item>
                  <q-item class="col-12">
                ...
                <q-item
                  class="col-12 text-bold text-indigo-9 text-subtitle2"
                  style="background-color: #e4fae9; -webkit-text-stroke: thin"
                >
                  <q-item-section>PAYABLE NOW</q-item-section>
                  <q-space />
                  <q-item-section class="text-right">
                    ₹ {{ this.payableAmount }}/-</q-item-section
                  >
                </q-item>
              </div>
            </div>
            ...
            >
              ...
              >
                <div class="col-2" style="padding-left: 10px">
                  <q-select
                    ...
                    option-label="code"
                    option-value="name"
                    v-model="travelBooking.selected_country"
                    :rules="[required('Code')]"
              ...
              <div
                class="q-mt-sm q-mb-sm text-bold text-body2"
                style="
                  font-family: verdana;
                  font-size: 18px;
                  padding-left: 10px;
              ...
              <div class="col-12 q-pa-xs q-mb-xs" style="padding-left: 10px">
                <q-input
                  ...
                  filled
                  outlined
                  v-model="travelBooking.email_id"
                  label="Email"
                  lazy-rules
                  hide-bottom-space
                  ref="verifyemailid"
              ...
              <div class="q-mt-md">
                <q-input
                  ...
                  filled
                  outlined
                  v-model="travelBooking.gstin_no"
              ...
              <div
                class="col-12 q-mx-xs margin-center"
          ...
          <!-- <q-card flat :class="class_val" class="row bg-transparent q-pa-xs lt-sm">
            <div
              class="col bg-white row"
              style="max-width: 402px; height: 500px"
            >
              <div class="row col-12">
                <div class="row col-12" style="border: 0px solid silver">
                  <div class="row col-12">
                    <div class="col-7 text-h6 text-bold q-pa-sm">
                      Your Details
                    </div>
                  </div>
                  <div
                ...
                >
                  ...
                  >
                    ...
                    <q-item class="col-12">
                      ...
                      <q-space />
                      <q-item-section class="text-right">
                        Rs.{{ this.travelcartRows.price }}
                        {{ this.travelcartRows.units }}</q-item-section
                      >
                    </q-item>

                    <q-item
                      class="col-12"
                      style="background-color: #e4fae9; padding-top: 10px"
                    >
                      <q-item-section class="text-bold"
                        >Total Price</q-item-section
                      >
                      <q-space />
                      <q-item-section class="text-right text-bold">
                        ...
                        {{
                          Math.round(
                            parseInt(this.travelcartRows.price).toFixed(2)
                          )
                        }}/-
                      </q-item-section>
                    </q-item>
                ...
                <div
                  class="row col-12"
                  style="border-top: 1px solid silver; border: 0px solid silver"
                  v-if="cardetails == true"
                >
                  <div class="row col-12">
                    <div class="col-7 text-h6 text-bold q-pa-sm">
                ...
                >
                  ...
                  >
                    <q-item class="col-12">
                      <q-item-section>Travel Charges</q-item-section>
                      <q-space />
                      <q-item-section class="text-right"
                        >Rs. {{ this.travelCharges }}/-</q-item-section
                      >
                    </q-item>
                    ...
                    <q-item
                      class="col-12 text-caption text-secondary text-bold"
                    >
                      <q-item-section>
                        {{ this.selected_offer_name }}/-</q-item-section
                      >
                    ...
                    <q-item class="col-12" style="background-color: #e4fae9">
                      ...
                      <q-space />
                      <q-item-section class="text-right">
                        Rs. {{ this.priceAfterDiscount }}/-</q-item-section
                      >
                    </q-item>
                    <q-item class="col-12">
                      <q-item-section class="text-bold text-subtitle2"
                    ...
                    <q-item class="col-12">
                      <q-item-section>Add GST @ (18%)</q-item-section>
                      <q-space />
                    ...
                    <q-item class="col-12" style="background-color: #e4fae9">
                      ...
                      <q-space />
                      <q-item-section class="text-right">
                        Rs. {{ this.payableAmount }}/-</q-item-section
                      >
                    </q-item>
                  </q-list>
                </div>
            ...
            <div
              ...
              style="max-width: 402px; height: 500px; overflow: auto"
            >
              <div class="row col-12">
                <div
                  class="text-caption text-bold q-mt-xs q-pa-sm text-silver"
                  style="font-family: verdana; font-size: 16px"
                >
                  MANGOHOMZ OFFERS
                </div>
                  ...
                  >
                    <div class="row col-12">
                      ...
                      <q-list color="secondary"
                        ><span
                          class="
                            text-secondary text-body2 text-bold
                            q-mr-xl q-pa-sm
                          "
                          style="font-family: verdana; font-size: 12px"
                          >{{ item.offer_name }}</span
            ...
            >
              <div
                class="q-mt-md text-bold text-body2"
                style="
                  font-family: verdana;
                  font-size: 18px;
                  padding-left: 10px;
          ...
          <q-card style="min-width: 350px">
            ...
            <q-card-section>
              <div style="font-family: verdana; font-size: 12px">
                ...
                facility, travel facility near medical hubs to medical
                travelers.<strong>MANGOHOMZ (MH)</strong> is not a medical
                professional and does not have any hired medical professionals
                working for their company to provide medical advice or make any
                medical recommendations, before or during medical trip. All
                information provided by <strong>MANGOHOMZ (MH)</strong>
                and its staff is strictly for informative and educational
                guidance and should not be interpreted as medical advice.
              </div>
              <div
              ...
              >
                ...
                discretion to change the Terms of this Agreement and will
                provide notice of any such changes by online posting. Your
                continued use of
                <a
                  class="text-bold text-primary"
                  href="https://mangohomz.com"
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                This User Agreement along with Terms Of Service (collectively,
                the "User Agreement") forms the terms and conditions for the use
                of services and products of MangoHomz(MH)
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                Any person ("User") who inquiries about or purchases any
                products or services of <strong>MANGOHOMZ (MH)</strong> through
                its websites, mobile applications, sales persons, offices, call
                centers, branch offices, franchisees, agents etc. (all the
                aforesaid platforms collectively referred to as "Sales
                Channels") agree to be governed by this User Agreement. The
                websites and the mobile applications of
                <strong>MANGOHOMZ (MH)</strong> are collectively referred to as
                'Website’ shall include channel Partners viz Accommodation
                Partner, Booking Agent Partner, Food Partner, Medicine & Medical
                Equipment Partner, Travel Partner
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
              ...
              >
                ...
                authorized to enter into an agreement so as become a User and
                use the services of <strong>MANGOHOMZ (MH)</strong>.
              </div>
              ...
              >
                ...
                membership and/or block access to the Website if it is
                discovered that a minor or a person incompetent to contract
                according to the law or any information pertaining to age
                entered at the time of creation of account is false.
              </div>
              ...
              >
                ...
                Users shall compulsorily read and understand this User
                Agreement, and shall be deemed to have accepted this User
                Agreement as a binding document that governs User's dealings and
                transactions with <strong>MANGOHOMZ (MH)</strong>. If the User
                does not agree with any part of this Agreement, then the User
                must not avail <strong>MANGOHOMZ (MH)</strong>'s services and
                must not access or approach the Sales Channels of
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                All content provided through various Sales Channels, including
                but not limited to audio, images, software, text, icons and such
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                <strong>MANGOHOMZ (MH)</strong> respects the intellectual
                property rights of others. If you notice any act of infringement
                on the Website, you may inform <strong>MANGOHOMZ (MH)</strong>,
                at
                <a
                  class="text-bold text-primary"
                ...
                Website. The Website is meant to be used by bonafide User(s) for
                a lawful use
              </div>
              ...
              >
                ...
                anything from the Website, including but not limited to any
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                Access to certain features of the Website may only be available
                to registered User(s). The process of registration may require
                the User to answer certain questions or provide certain
                information that may or may not be personal in nature. Some such
                fields may be mandatory or optional. User represents and
                warrants that all information supplied to
                <strong>MANGOHOMZ (MH)</strong> is true and accurate.
              </div>
              ...
              >
                ...
                members/relatives/escorts/friends making the booking on behalf
                of the Participant/Patient shall read carefully the terms and
                ...
                members/relatives/escorts/friends making the booking on behalf
                of the Participant/Patient) shall mean acceptance in totality of
                the terms and conditions contained herein by the
                Participant/Patient (and his/her family
                members/relatives/escorts/friends making the booking on behalf
                of the Participant/Patient). The signed terms & conditions
                documents with payment receipt shall be binding on the
                Participant/Patient (and his/her family members/
                relatives/escorts/friends making the booking on behalf of the
                User/Participant/ Patient) and shall constitute a contract
                between MANGOHOMZ and the User/Participant/Patient (and his/her
                family/members/relatives/escorts/friends making the booking on
                behalf of the Participant / Patient) on the Participant /
                Patient (and his / her family members / relatives / escorts /
                friends making the booking on behalf of the Participant /
                Patient) signing the terms and conditions document and making
                payment towards the Package.
              </div>
              ...
              >
                ...
                in selecting all the ingredients required by Medical Traveler
                and has no control whatsoever in running the Channel partner.
                MANGOHOMZ cannot be made liable / responsible for any delay,
                default, failure, improper services / deficiency in services
                provided by the Channel partner and / or for any injury,
                sickness, accident, discomfort, death, loss or damage of any
                kind whatsoever which may arise due to any act of negligence,
                deficiency or default in services, of the management or
                employees of the Channel partner.
              </div>
              ...
              >
                ...
                responsible for providing a comfortable room stay, travel
                facility to medical hub and other connected facility for
                ensuring the acceptability of the services as promised by
                <strong>MANGOHOMZ (MH)</strong> to its customers on behalf of
                its partner. <strong>MANGOHOMZ (MH)</strong> has right to direct
                the Accommodation owner to provide the room stay services along
                with other adequate facility as promised for, to
              ...
              >
                ...
                hospital/Treating Institution through its platform to service
                its medical travelers.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                C <strong>MANGOHOMZ (MH)</strong> markets the room stays,
                providing its medical travelers with the room booking voucher
                that entitles them to avail Hotel stay service in
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                D. In case medical travelers are not able to select the
                facilities from our website, they can call our customer support
                desk and our team will help you find a suitable
                accommodation/facility within preferred budget and amenities
                near the Medical hub
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                E. If any check-in is denied for a confirmed booking, MANGOHOMZ
                MH shall ensure that User is provided with an alternate
                accommodation of comparable standards. In an event, where the
                alternate accommodation could not be provided, MANGOHOMZ MH
                shall arrange for the refund (as per
                <strong>MANGOHOMZ (MH)</strong>)
                <a
                  class="text-bold text-primary"
                  @click="refundDialog = true"
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                H. MANGOHIMZ MH stays involved with the Users right from the
                time when booking is made through MANGOHIMZ MH platform and
                throughout the hotel stays, ensuring that the User gets a
                comfortable room stay experience.
              </div>
              ...
              >
                ...
                any such services shall be the sole responsibility of the
                Service Provider. <strong>MANGOHOMZ (MH)</strong> liability
                shall be limited to the arrangement of service, liability with
                respect to quality of services shall lie with the accommodation
                partner. Any acts, omissions, errors, representations,
                warranties, breaches or negligence on part of any Service
                Provider shall be his responsibility
              </div>

              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                Unless explicitly committed by
                <strong>MANGOHOMZ (MH)</strong> as a part of any product or
                service:
              </div>
              ...
              >
                ...
                Service Provider is found to be inaccurate, inadequate or
                obsolete or in contravention of any laws, rules, regulations or
                directions in force.
              </div>
              ...
              >
                ...
                or as laid out in the confirmed booking voucher. These
                conditions are also to be read in consonance with the User
                Agreement.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                The User undertakes to abide by all procedures and guidelines,
                as modified from time to time, in connection with the use of the
              ...
              >
                ...
                <strong>MANGOHOMZ (MH)</strong> expressly disclaims all
                warranties of any kind, whether express or implied, including,
                but not limited to the implied warranties of merchantability,
                reasonably fit for all purposes. No advice or information,
                whether oral or written, which the User obtains from
              ...
              >
                ...
                representative to contact such user over phone, message and
                email. This consent shall supersede any preferences set by such
                User through national customer preference register (NCPR) or any
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                In cases of short charging of the booking amount, taxes,
                statutory fee, convenience fee etc., owing to any technical
                error or other reason, <strong>MANGOHOMZ (MH)</strong> shall
                reserve the right to deduct, charge or claim the balance amount
                from the User and the User shall pay such balance amount to
                <strong>MANGOHOMZ (MH)</strong>. In cases where the short charge
                is claimed prior to the utilization of the booking,
                <strong>MANGOHOMZ (MH)</strong> will be at liberty to cancel
              ...
              >
                ...
                taxes or imposition of new taxes, levies by Government shall
                have to be borne by the User. Such imposition of taxes, levies
                may be without prior notice and could also be retrospective but
              ...
              >
                ...
                and <strong>MANGOHOMZ (MH)</strong> as the case may be. (<a
                  class="text-bold text-primary"
                  @click="refundDialog = true"
                  href="#"
                  >Refund Policy</a
              ...
              >
                ...
                <strong>MANGOHOMZ (MH)</strong> or its agents, representatives
                or employees shall never ask a customer to transfer money to any
                private account or to an account not held in the name of
                <strong>MANGOHOMZ (MH)</strong>. The User agrees that if that
                user transfers any amount against any booking or transaction to
                any bank account that is not legitimately held by
                <strong>MANGOHOMZ (MH)</strong> or to any personal account of
                any person, <strong>MANGOHOMZ (MH)</strong> shall not be held
                liable for the same. User shall not hold any right to recover
                from <strong>MANGOHOMZ (MH)</strong> any amount which is
                transferred by the User to any third party.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                ...
                or representatives of <strong>MANGOHOMZ (MH)</strong>. The User
                shall immediately inform <strong>MANGOHOMZ (MH)</strong> if such
                details are demanded by any of its agents' employees or
                representatives. <strong>MANGOHOMZ (MH)</strong> shall not be
                liable for any loss that the User incurs for sharing the
                aforesaid details.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                Refunds, if any, on cancelled bookings will always be processed
                to the respective account or the banking instrument (Credit
                Card,
                <strong>MANGOHOMZ (MH)</strong> wallet etc) from which payment
                was made for that booking
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
              ...
              >
                ...
                <strong>MANGOHOMZ (MH)</strong> irrespective of VISA.
                Arrangement of VISA in any case is not the responsibility of
                <strong>MANGOHOMZ (MH)</strong>. OK TO BOARD permission are to
                be obtained by the User as per the requirement of their travel
                bookings and the requirements of the countries the User intends
                to visit or transit through.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                <strong>MANGOHOMZ (MH)</strong> is not responsible for any
                issues, including inability to travel, arising out of visa
              ...
              >
                ...
                <strong>MANGOHOMZ (MH)</strong> and / or the Service Providers
                may be unable to honor the confirmed bookings due to various
                reasons like act of God, labor unrest, insolvency, a pandemic,
                an epidemic, business exigencies, government decisions,
                terrorist activity, any operational and technical issues, route
                and flight cancellations etc. or any other reason beyond the
                control of <strong>MANGOHOMZ (MH)</strong> . If
                <strong>MANGOHOMZ (MH)</strong> has advance knowledge of any
                such situations where dishonor of bookings may happen, it will
                make its best efforts to provide similar alternative to the User
                or refund the booking amount after deducting applicable service
                charges, if supported and refunded by that respective service
                operators. The User agrees that
                <strong>MANGOHOMZ (MH)</strong> being merely a facilitator of
                the services and products booked cannot be held responsible for
                any such Force Majeure circumstance. There can’t be any direct
                interaction between service providers and user MH will be the
                only point of interaction for users
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                The User agrees that in the event of non-confirmation of booking
                due to any technical reasons (like network downtime,
                disconnection with third party platforms such as payment
                gateways, banks etc.) or any other similar failures,
                <strong>MANGOHOMZ (MH)</strong> ’s obligation shall be limited
                to refunding the booking amount, if any, received from the
                customer. Such refund shall completely discharge
                <strong>MANGOHOMZ (MH)</strong> from all liabilities with
                respect to that transaction. Additional liabilities, if any,
              ...
              >
                ...
                consequential damages, and any other damages like damages for
                loss of use, data or profits, arising out of or in any way
                connected with the use or performance of the Website or any
                other Sales Channel.
              </div>
              <div
                class="text-bold text-left"
              ...
              >
                ...
                <strong>MANGOHOMZ (MH)</strong> under this User Agreement or
                under applicable law, <strong>MANGOHOMZ (MH)</strong> may limit
                the User's activity, warn other users of the User's actions,
              ...
              >
                ...
                law or otherwise result in any liability for the User, other
                users of <strong>MANGOHOMZ (MH)</strong> , or
                <strong>MANGOHOMZ (MH)</strong> itself.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                Once a User has been suspended or terminated, such User shall
                not register or attempt to register with
                <strong>MANGOHOMZ (MH)</strong> with different credentials, or
                use the Website in any manner whatsoever until such User is
                reinstated by <strong>MANGOHOMZ (MH)</strong>.
              ...
              >
                ...
                <strong>MANGOHOMZ (MH)</strong> reserves the right to recover
                any amounts due to be paid by the User to
              ...
              >
                ...
                the service(s), agreed to be provided to the User, for any
                booking made through
                <strong>MANGOHOMZ (MH)</strong> with/without assigning any
                reasons or owing to reasons including but not limited to
                behavioral issues, public safety, health hazards, infectious
                diseases, government orders/notification etc. In such scenarios
                of refusal, the liability that may ensue shall solely vest with
                the end service provider as it is outside the purview of
              ...
              >
                ...
                <strong>MANGOHOMZ (MH)</strong> with correct and valid
                information while making use of the Website under this User
                Agreement, and not to make any misrepresentation of facts. Any
                default on part of the User would disentitle the User from
                availing the services from <strong>MANGOHOMZ (MH)</strong> .
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                ...
                the travelers is not correct or that any fact has been
                misrepresented by that User,
                <strong>MANGOHOMZ (MH)</strong> shall be entitled to appropriate
                legal remedies against the User, including cancellation of the
                bookings, without any prior intimation to the User. In such an
                event, <strong>MANGOHOMZ (MH)</strong> shall not be responsible
                or liable for any loss or damage that may be caused to the User
                or any other person in the booking, as a consequence of such
              ...
              >
                ...
                government authority approaches
                <strong>MANGOHOMZ (MH)</strong> to cancel any booking,
                <strong>MANGOHOMZ (MH)</strong> will cancel the same without
                approaching the concerned User whose booking has been cancelled.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                The User shall not hold
                <strong>MANGOHOMZ (MH)</strong> responsible for any loss or
                damage arising out of measures taken by
                <strong>MANGOHOMZ (MH)</strong> for safeguarding its own
                interest and that of its genuine customers. This would also
                include <strong>MANGOHOMZ (MH)</strong> denying or cancelling
              ...
              >
                ...
                respective officers, directors, lawful successors and assigns
                ...
                thereon) asserted against or incurred by such indemnified
                persons, that arise out of, result from, or may be payable by
                virtue of, any breach of any representation or warranty provided
                by the User, or non-performance of any covenant by the stay
                User.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              ...
              >
                ...
                by MANGOHOMZ as confidential shall be maintained confidentially
                by the User and shall not be disclosed unless as required by law
                or to serve the purpose of this User Agreement and the
                obligations of both the parties herein.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                FEEDBACK FROM CUSTOMER: <strong>MANGOHOMZ (MH)</strong> would
                like to know the feedback of the Users for improving its
                services. The User hereby authorizes MANGOHOMZ to contact the
                User for their feedback on various services offered by
                MANGOHOMZ. Such feedback may be collected through emails,
                telephone calls, SMS or any other medium from time to time. In
                case the User chooses not to be contacted, such User shall write
                to MANGOHOMZ for specific exclusion at
                <a
                  class="text-bold text-primary"
              ...
              >
                ...
                personal information by MANGOHOMZ and its affiliates in
                accordance with the terms of the Privacy policy.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                GRIEVANCE REDRESSAL: MANGOHOMZ strongly believes in resolving
                the issues raised by the User(s). In the event if user feels
                that it’s concern has not been resolved to it’s satisfaction,
                User may contact our
                <a class="text-bold" href="#" @click="openGrievanceDialog()"
                  >grievance officer</a
                >
                who shall Endeavour to redress the concern within 30 working
                days from the date of escalation. To reach the Grievance Officer
                please use this
                <a
                  class="text-bold text-primary"
                  href="https://mangohomz.com"
        ...
        <q-dialog v-model="privacyPolicyDialog">
          <q-card style="min-width: 350px">
            ...
            <q-card-section>
              ...
              <div style="font-family: verdana; font-size: 12px">
                This notice applies to anyone who interacts with us in relation
                to our products and services (“you”, “your”), via any channel
                (e.g. app, website, email, phone, walk-ins to MangoHomz
                accommodations, booking an MangoHomz accommodation etc.). We may
                give you additional privacy notices if required for specific
                interactions.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              ...
              <div style="font-family: verdana; font-size: 12px">
                ...
                you book), you must ensure that the privacy policy is seen by
                them and they are comfortable with you doing this.
              </div>
              <div
                class="text-bold text-left"
                style="
              ...
              <div style="font-family: verdana; font-size: 12px">
                ...
                process. Standard personal information is normally processed by
                us on the basis that it is necessary for the performance of a
              ...
              <div style="font-family: verdana; font-size: 12px">
                ...
                improvement purposes and in order to exercise our rights or
                handle claims. More detailed information about our legitimate
              ...
              >
                ...
                preferences and interests so that we can send recommendations
                and marketing communications that are likely to be of more
                interest to you. Using technology in this way is sometimes known
                as profiling.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                ...
                at any time by clicking on the "unsubscribe" link that appears
                in all emails and by adjusting the settings on your device to
                turn off notifications from our app. Otherwise, you can always
                contact us at dataprotection@Mangohomz.com to update your
                contact preferences. You may also object to profiling relating
                to direct marketing by contacting us at dataprotection
                @Mangohomz.com.
              </div>
              <div
                class="text-bold text-left"
              ...
              <div style="font-family: verdana; font-size: 12px">
                ...
                marital status, religion, age, profile picture etc., your
                contact details such as your email address, postal addresses,
                frequent flyer number, telephone (mobile or otherwise) and/or
                fax numbers. The information may also include information such
                as your banking details (including credit/debit card) and any
              ...
              <div style="font-family: verdana; font-size: 12px">
                <ul>
                  ...
                  <li>
                    Information pertaining any other traveler(s) for who you
                    make a booking through your registered MANGOHOMZ account. In
                    such case, you must confirm and represent that each of the
                    other traveler(s) for whom a booking has been made, has
                    agreed to have the information shared by you disclosed to us
                    and further be shared by us with the concerned service
                    provider(s).
                  </li>
                  <li>
                    ...
                    information which may be required by the respective embassy
                  ...
                  <li>
                    ...
                    information, MANGOHOMZ may not be able to process the
                    booking. MANGOHOMZ will never share User’s PAN details
              ...
              <div style="font-family: verdana; font-size: 12px">
                ...
                MANGOHOMZ may share this information with the end service
                provider or any other third party for provision and facilitation
                of the desired booking. MANGOHOMZ will always redact all/any
                sensitive & confidential information contained in the
                vaccination certificate, passbook, bank statement or any other
                identity card submitted for the purpose of availing a service,
                promotional offer or booking a product on the Website. In case a
                User does not wish to provide this information or opts for
                deletion of the information already provided, MANGOHOMZ may not
                be able to process the desired booking request. MANGOHOMZ will
                never share any of the above information collected including PAN
                card details, Passport details, Aadhar Card details without
                their prior consent unless otherwise such action is required by
                any law enforcement authority for investigation, by court order
                or in reference to any legal process.
              </div>
              <div
                class="text-bold text-left"
                style="
              ...
              <div style="font-family: verdana; font-size: 12px">
                ...
                marketing and report on the performance of that marketing. We
                also use Google Place API to make suggestions based on your
                location or search strings.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
              ...
              <div style="font-family: verdana; font-size: 12px">
                <ul>
                  ...
                  <li>
                    Third party suppliers who help deliver products or services
                    on our behalf, or who have partnered with Mangohomz in
                    connection with services or a relevant promotional offering,
                    as well as other apps or websites that integrate with our
                    API or Services, or those with an API or Service with which
                    we integrate;
                  </li>
                  ...
                  <li>
                    ...
                    features and related tools which let you share your
                    Mangohomz experience with other apps, sites, or media, and
                    vice versa. Your use of these features enables the sharing
                    of information with your friends or the public, depending on
                    your social sharing service settings. Please refer to the
              ...
              <div style="font-family: verdana; font-size: 12px">
                MangoHomz uses global information systems. As a result,
                MangoHomz transfers your personal information to a country
                outside of your country, for the purposes set out in this
                policy.
              </div>
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              ...
              >
                ...
                MangoHomz’s records retention policies. However, there may be
                circumstances that mean we must retain your personal information
                for longer (e.g. if you make a claim in relation to a booking).
              </div>
              <div
                class="text-bold text-left"
                style="
              ...
              <div style="font-family: verdana; font-size: 12px">
                Data protection laws provides individuals with rights in
                relation to the information that MangoHomz holds about them on
                some computer and paper records. These include rights to access,
              ...
              <div style="font-family: verdana; font-size: 12px">
                ...
                in relation to this notice, or any other concerns about the way
                in which we process information about you, please contact our
                Privacy Team at
                <a
                  class="text-bold text-primary"
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                If you are not satisfied with the response from our Privacy
                Team, you can contact our Data Protection Officer at [<a
                  class="text-bold text-primary"
                  href="dataprotection@mangohomz.com."
                  target="_blank"
                  >dataprotection@mangohomz.com.</a
          ...
          <q-card style="min-width: 350px">
            ...
            <q-card-section>
              ...
              <div
                style="font-family: verdana; font-size: 12px; padding-top: 10px"
              >
                <strong>MANGOHOMZ (MH)</strong> strict cancellation policy
                allows MangoHomz Guests to receive a full refund if they cancel
                the pre-booked transport at least 3 days before the booked date.
                Any cancellation thereafter the guest will be entitled to get
          ...
          <q-card style="min-width: 350px">
            ...
            <q-card-section>
              ...
              >
                ...
                use or User may opt for refund to the account/Card from where
    ...
    <!--mobile view end-->
    <!--website view start-->
    <q-page style="padding-top: 60px" class="q-pa-md bg-grey gt-sm">
      <div class="justify-center">
        <div class="q-pa-md row justify-center q-gutter-md">
            ...
            <q-card flat class="bg-white;" style="width: 100%">
              ...
              >
                ...
                <div class="row q-mt-sm" style="padding-top: 20px">
                  <div class="col-4 q-pa-xs" style="text-align: center">
                    <div class="text-bold text-subtitle">
                      <q-icon size="3em" name="mdi-map-marker-radius" />
                      {{ bookingId.data[0].property_name }}
                    </div>
                    <div class="text-subtitle" style="font-size: 12px">
                      <q-icon color="secondary" size="1.5em" name="mdi-city" />
                      {{ bookingId.data[0].property_city_name }}, India.
                    </div>
                    <div class="text-subtitle" style="font-size: 12px">
                  ...
                  <div
                    ...
                    style="background-color: #e4fae9; width: 550px"
                  >
                    <div class="col-4">
                      <div class="text-caption">
                        <q-icon name="event" class="cursor-pointer"></q-icon>
                    ...
                    <div class="col-4">
                      ...
                      <div class="text-caption">
                        {{
                          moment(bookingId.data[0].check_out).format("h:mm a")
                        }}
                      </div>
                    </div>
                    <div class="col-4">
          ...
          >
            <q-card flat style="height: auto; width: 100%">
              <div class="row">
                <div class="text-h6 text-bold q-pa-sm">Book Your Ride</div>
                <q-space />
              </div>
              <q-separator v-if="bookingId.data[0]" />
              <q-card-actions
                ...
                v-if="bookingId.data[0]"
              >
                <!-- <div class="row items-start text-bold q-gutter-md">
                <q-select dense options-dense outlined dark  class="text-bold"
                       v-model="Travelcab.bookingcabdetails" bg-color="primary"
                      label="Booking Online Cab *" aria-checked use-input style="width: 200px" filled hide-bottom-space
                      :options="['OneSide', 'RoundTrip']" label-color="white" :rules="[required('Booking Online Cab')]"
                      color="cyan" @input="getdata(Travelcab.bookingcabdetails)">
                  </q-select>
              </div> -->
                <div class="row items-start text-bold q-gutter-md">
                  <q-input
                      ...
                      <q-icon color="white" name="event" class="cursor-pointer">
                        ...
                        >
                          <q-date
                            ...
                            v-model="bookingTravel.date"
                            :options="optionsFn"
                            @input="closeDialog(), getdate(bookingTravel.date)"
                          >
                            <div class="row items-center justify-end">
                              <q-btn
                                v-close-popup
                  ...
                  <!-- <q-input dense outlined dark ref="checktime" bg-color="primary" label="Time" label-color="white"
                    clear-icon="close" minimal  v-model="bookingTravel.time" @click="$refs.qTimeProxy.show()"
                    style="width: 120px" :rules="[required('Time')]">
                    <template v-slot:append>
                      <q-icon color="white" name="access_time" class="cursor-pointer">
                        <q-popup-proxy ref="qTimeProxy" minimal transition-show="scale" transition-hide="scale">
                          <q-time minimal mask="HH:mm" v-model="bookingTravel.time" @input="closeDialog1()" format24h>
                            <div class="row items-center justify-end">
          ...
          >
            ...
            >
              ...
              <!-- <div class="q-mt-sm text-bold text-body2" style="
                  font-family: verdana;
                  font-size: 18px;
                  padding-left: 10px;
                ">
              ...
              <!-- <div class="row items-start q-gutter-md " style="padding-top: 10px">
                <div class="col-2" style="padding-left: 50px">
                  <q-input dense filled outlined v-model="travelBooking.whatsapp" ref="verifywhatsapp"
                    :rules="[required('Mobile Number'), phone()]" label="Enter Mobile No *" lazy-rules mask="##########"
                    style="width: 220px; font-family: verdana; font-size: 12px" label-color="black" hide-bottom-space>
                    <template v-slot:prepend>
                      <q-icon name="mdi-phone" color="secondary" />
                    </template>
                  </q-input>
              ...
              <!-- <div class="row justify-center">
                <q-btn color="positive" label="PROCEED TO PAY" style="font-family: verdana; font-size: 12px"
                  class="text-bold" label-color="black" @click="submitBookingData()" />
              </div> -->
              <div
                class="col-12 q-mx-xs margin-center"
                style="padding-top: 20px"
...
export default {
  ...
  data() {
    return {
      ...validations,
      bookingId: null,
      travelImgpath: filepaths.mhtpFilePath,
      class_val: "shadow-1 hotel-details-card-1",
      // bg_color: "background-color:#E4FAE9",
      moment: moment,
      right: false,
      days: 0,
      confirm: false,
      ...
      cart_total: "",
      food_total: "",
      selected_offer_name: "APPLY COUPON",
      ...
      selectCab: "Please Select Cab Details",
      travelRows: {
        agent_id: "",
        account_id: "",
        transport_sub_id: "",
        transport_email_id: "",
        alternatetransport_email_id: "",
        transport_phone: "",
        travel_name: "",
        transport_sub_name: "",
      ...
      guesttravelbooking: {
        ...
        account_id: "",
        transport_sub_id: "",
        transport_partner_email: "",
        transport_partner_AlternateEmail: "",
        transport_partner_phone: "",
        travel_name: "",
        transport_sub_name: "",
        vehicle_type: "",
        vehicle_name: "",
  ...
  created() {
    // this.bookingId = "";
    // // this.bookingId = this.$route.params.GuestNo;

    // this.bookingId = JSON.parse(this.$route.params.GuestNo);

    // //  this.bookingId = this.$route.params.GuestNo;
    // console.log("travelBooking",this.bookingId,this.bookingId_arr);
    // this.travelBooking.phone = this.bookingId.data[0].primary_no;
    // // this.travelBooking.whatsapp=this.bookingId.data[0].alternate_no
    // this.travelBooking.email_id = this.bookingId.data[0].email_id;
    this.hotelImgpath = filepaths.mhapFilePath;
    this.OfferImgpath = filepaths.mhapFilePath;
    this.calculateTravelkiloMeter();
  },
  computed: {
    ...mapState({
      filteredPointTypes: (state) => state.dropdown.travelpoint_type,
      filteredPointNames: (state) => state.dropdown.travelpoint_name,
      optionsFn(d) {
        let fromDate = date.formatDate(
          this.bookingId.data[0].check_in,
          "YYYY/MM/DD"
        );
        let toDate = date.formatDate(
          this.bookingId.data[0].check_out,
          "YYYY/MM/DD"
        );
        // return d => d == fromDate || d == toDate;

        // let fromDate = date.formatDate(this.bookingId.data[0].check_in, "YYYY/MM/DD");
        // let toDate = date.formatDate(this.bookingId.data[0].check_out, "YYYY/MM/DD");
        // let selectedDate = moment(this.bookingTravel.date, "DD/MM/YYYY").format("YYYY/MM/DD");
      ...
      sub_travel_item_rows: (state) => state.partners.sub_travel_item_rows,
      sub_travel_cart_rows: (state) => state.partners.sub_travel_cart_rows,
      mangohomzOffers_arr: (state) => state.booking.mangohomzOffers_arr,
      bookingId_arr: (state) => state.booking.bookingId_arr,
    }),
    win_width() {
    ...
    travelCharges() {
      let travelCharges = Math.round(
        parseFloat(this.travelcartRows.price).toFixed(2)
      );
    ...
    //     (parseFloat(this.travelcartRows.price).toFixed(2) *
    //       parseInt(this.days) *
    //       parseFloat(this.travelcartRows.special_offer).toFixed(2)) /
    //       100
    //   );
    //   return discount;
    // },
    ...
    //     parseFloat(this.travelcartRows.price).toFixed(2) * parseInt(this.days) -
    //       (parseInt(this.travelcartRows.price).toFixed(2) *
    //         parseInt(this.days) *
    //         parseFloat(this.travelcartRows.special_offer).toFixed(2)) /
    //         100
    ...
    priceAfterDiscount() {
      let priceAfterDis = 0;
      if (this.travelcartRows.units === "Per/Km") {
        priceAfterDis = Math.round(
          parseFloat(
            this.travelcartRows.price *
              this.bookingTravel.selectedPointName.kiloMeter
          ).toFixed(2) - parseFloat(this.selected_offer_price).toFixed(2)
        );
      } else if (this.travelcartRows.units === "Per/Trip") {
        priceAfterDis = Math.round(
          parseFloat(this.travelcartRows.price).toFixed(2) -
    ...
    gstOnPrice() {
      let gst = 0;
      if (this.travelcartRows.units === "Per/Km") {
        gst = Math.round(parseFloat(this.basePrice * 18) / 100);
      } else if (this.travelcartRows.units === "Per/Trip") {
        gst = Math.round(parseFloat(this.travelcartRows.price * 18) / 100);
      }
      return gst;
    },
    cgstOnPrice() {
    ...
    payableAmount() {
      let payAmount = Math.round(
        parseFloat(this.priceAfterDiscount + parseInt(this.gstOnPrice))
      );
      return payAmount;
    },
  },
 async mounted() {
  ...
  let bookingIdRoute = this.$route.params.GuestNo;
  try {
    ...
    //  this.bookingId = this.$route.params.GuestNo;
    // console.log("travelBooking",this.bookingId.data[0],this.bookingId);
    this.travelBooking.phone = this.bookingId.data[0].primary_no;
    // this.travelBooking.whatsapp=this.bookingId.data[0].alternate_no
    this.travelBooking.email_id = this.bookingId.data[0].email_id;
    ...
    this.$store.dispatch(
      "dropdown/loadAllPointTypes",
      this.bookingId.data[0]
    );


    this.$store.dispatch("booking/getMangohomzOfferDataTravel");
    // this.$store.dispatch(`booking/getBookingIdDetails`, this.bookingId);
    let hotelSerachDetails =
      JSON.parse(localStorage.getItem("searchItem")) || [];
    if (hotelSerachDetails.dateModel && hotelSerachDetails.dateModel.from) {
      this.searchItem = {
    ...
    this.account_id = this.$store.state.booking.account_id;
    this.partner_id = this.$store.state.booking.partner_id;
    this.partner_sub_id = this.$store.state.booking.partner_sub_id;
    this.Property_id = this.$store.state.booking.Property_id;
    this.room_txn_id = this.$store.state.booking.room_txn_id;
    ...
    this.selected_room_type = this.$store.state.booking.selected_room_type;
    ...
    // this.rating = this.$store.state.booking.rating;
    this.room_total = this.selected_property_min_price * this.days;
    this.cart_total = this.room_total;
    // this.$store.dispatch("partners/getTravelbookingDetails");
  },
  ...
  methods: {
    ...
    ...mapActions("booking", ["getMangohomzOfferDataTravel"]),
    ...mapActions("partners", ["getTravelbookingDetails"]),
    ...mapActions("partners", ["getTravelBookingData"]),
    ...mapActions("partners", ["getTravelBookingcart"]),
    ...mapActions("booking", ["getBookingIdDetails"]),
    ...mapActions("booking", ["submittravelDetails"]),
    ...
    async fetchData(bookingIdRoute) {
      try {
        const response = await api.get(
          `/booking/getBookingIdDetails/${bookingIdRoute}`
        );
    ...
    //     this.travelcartRows.day_price;
    //   } else {
    //     this.travelcartRows.night_price;
    //   }
    //   return splittime;

    // },
    traveldata(item) {
      if (this.$refs.checkdate.validate()  && this.$refs.checktime.validate() ) {
        var travelObj = {
          time: this.bookingTravel.time,
          city_id: item,
        };
        this.getTravelbookingDetails(travelObj);
      }
    },
    travelpartner(item) {
      var partnerObj = {
        ...
        transport_sub_id: item.transport_sub_id,
        transport_email_id: item.transport_email_id,
        alternatetransport_email_id: item.alternatetransport_email_id,
        transport_phone: item.transport_phone,
        // status: item.status,
        // travel_status: item.travel_status
      };
      const index = this.travel_item_rows.indexOf(item);
      this.travelRows = Object.assign({}, item);
      this.getTravelBookingData(partnerObj);
    },
    cartdetails(item) {
      this.selectCab = "";
      this.cardetails = true;
      this.travelcartRows = Object.assign({}, item);
      this.getTravelBookingcart(item);
      this.travelcartRows.agent_id = item.agent_id;
      this.travelcartRows.account_id = item.account_id;
      this.travelcartRows.txn_id = item.txn_id;
      this.travelcartRows.transport_sub_id = item.transport_sub_id;
      this.travelcartRows.travel_name = item.travel_name;
      this.travelcartRows.transport_sub_name = item.transport_sub_name;
      this.travelcartRows.vehicle_type = item.vehicle_type;
      this.travelcartRows.no_of_seaters = item.no_of_seaters;
      this.travelcartRows.price = item.price;
      this.travelcartRows.special_offer = item.special_offer;
      this.travelcartRows.vehicle_name = item.vehicle_name;
      this.travelcartRows.units = item.units;
    },
    // loadbookingId(item) {
    //  this.resetfiles();
    //   if (
    //     this.$refs.bookingid.validate()
    //   ) {

    //     this.getBookingIdDetails(item);

    //   }
    // },
    resetfiles() {
      this.bookingId_arr.length = [];
      this.$store.state.partners.travel_item_rows = [];
      this.$store.state.partners.sub_travel_item_rows = [];
      this.$store.state.partners.sub_travel_cart_rows = [];
    },
    // ifempty() {
    //   if (this.bookingId_arr.length =="") {
    //     this.$q.notify({
    //       type: "negative",
    ...
    submitBookingData() {
      if (
        ...
        this.$refs.verifyemailid.validate()
      ) {
        this.$q
          .dialog({
            title: "Confirm",
          ...
          .onOk(() => {
            this.guesttravelbooking.booking_id =
              this.bookingId.data[0].booking_id;
            this.guesttravelbooking.booking_order_id =
              this.bookingId.data[0].booking_order_id;
            this.guesttravelbooking.property_city_name =
              this.bookingId.data[0].property_city_name;
            this.guesttravelbooking.property_city_id =
              this.bookingId.data[0].property_city_id;
            this.guesttravelbooking.check_in = this.bookingId.data[0].check_in;
            this.guesttravelbooking.check_out =
              this.bookingId.data[0].check_out;
            this.guesttravelbooking.guest_count =
              this.bookingId.data[0].guest_count;
            this.guesttravelbooking.no_of_days =
              this.bookingId.data[0].no_of_days;
            this.guesttravelbooking.near_hospital_name =
              this.bookingId.data[0].near_hospital_name;

            // this.guesttravelbooking.bookingTravelObj = this.bookingTravel;

            this.guesttravelbooking.booked_date = this.bookingTravel.date;

            this.guesttravelbooking.origin = this.bookingTravel.Origin;

            this.guesttravelbooking.destination =
              this.bookingTravel.Destination.point_type;

            this.guesttravelbooking.destination1 =
              this.bookingTravel.Destination1.point_type;

            this.guesttravelbooking.destination_name =
              this.bookingTravel.selectedPointName.point_name;
            this.guesttravelbooking.transport_partner_email =
              this.travelRows.transport_email_id;
            this.guesttravelbooking.transport_partner_AlternateEmail =
              this.travelRows.alternatetransport_email_id;

            this.guesttravelbooking.transport_partner_phone =
              this.travelRows.transport_phone;

            this.guesttravelbooking.origin1 = this.bookingTravel.Origin1;
            this.guesttravelbooking.booking_time = this.bookingTravel.time;
            this.guesttravelbooking.travel_charges = this.travelCharges;
            // this.guesttravelbooking.discount = this.travelcartRows.special_offer;
            // this.guesttravelbooking.discount_price = this.discount;
            // this.guesttravelbooking.base_price = this.basePrice;
            this.guesttravelbooking.mh_offer_coupon =
              this.selected_offer_name == "APPLY COUPON"
                ? ""
                : this.selected_offer_name;
            this.guesttravelbooking.mh_offer_price = this.selected_offer_price;
            this.guesttravelbooking.price_after_discount =
              this.priceAfterDiscount;
            this.guesttravelbooking.gst_percentage = 18;
            this.guesttravelbooking.gst_on_base_price = this.gstOnPrice;
            this.guesttravelbooking.gst_percentage = 18;
            this.guesttravelbooking.cgst_amount = this.cgstOnPrice;
            this.guesttravelbooking.cgst_percentage = 9;
            this.guesttravelbooking.sgst_amount = this.cgstOnPrice;
            this.guesttravelbooking.sgst_percentage = 9;
            this.guesttravelbooking.payable_amount = this.payableAmount;
            this.guesttravelbooking.country_name =
              this.travelBooking.selected_country.name;
            this.guesttravelbooking.country_code =
              this.travelBooking.selected_country.code;
            this.guesttravelbooking.gst_number = this.travelBooking.gstin_no;
            this.guesttravelbooking.mobile_number = this.travelBooking.phone;
            this.guesttravelbooking.whatsapp_number =
              this.travelBooking.whatsapp;
            this.guesttravelbooking.email_id = this.travelBooking.email_id;
            this.guesttravelbooking.agent_id = this.travelcartRows.agent_id;
            this.guesttravelbooking.account_id = this.travelcartRows.account_id;
            this.guesttravelbooking.transport_sub_id =
              this.travelcartRows.transport_sub_id;
            this.guesttravelbooking.travel_name =
              this.travelcartRows.travel_name;
            this.guesttravelbooking.transport_sub_name =
              this.travelcartRows.transport_sub_name;
            this.guesttravelbooking.txn_id = this.travelcartRows.txn_id;
            // this.guesttravelbooking.vehicle_type = this.travelcartRows.vehicle_type;
            this.guesttravelbooking.no_of_seaters =
              this.travelcartRows.no_of_seaters;
            this.guesttravelbooking.price = this.travelcartRows.price;
            // this.guesttravelbooking.special_offer =
            //   this.travelcartRows.special_offer;
            this.guesttravelbooking.vehicle_name =
              this.travelcartRows.vehicle_name;
            this.guesttravelbooking.units = this.travelcartRows.units;
            let guestTravelData = this.guesttravelbooking;
            this.showRazorpay(guestTravelData);
            // this.$router.push({
            //   name: "TravelData To PaymentPage",
            //   params: { travelbookingdata: guestTravelData },
            //   });
          });
      } else {
        this.$q.notify({
          color: "negative",
          message: "Please Select Cab to Continue",
        });
      }
    },
    loadScript(src) {
    ...
    async showRazorpay(item) {
      ...
      api
        .post("/razorPayPayment/travelPayment", paymentObj)
        .then((response) => {
    ...
    handleOriginPointTypeChange() {
      const cityCode = this.bookingId.data[0].property_city_id;
      const pointType = this.bookingTravel.Origin.point_type;
      const txnId = this.bookingId.data[0].hotel_txn_id;
      this.$store.dispatch("dropdown/loadAllPointNames", {
        city_code: cityCode,
    ...
    handleOriginPointTypeChange1() {
      const cityCode = this.bookingId.data[0].property_city_id;
      const pointType = this.bookingTravel.Destination1.point_type;
      const txnId = this.bookingId.data[0].hotel_txn_id;
      this.$store.dispatch("dropdown/loadAllPointNames", {
        city_code: cityCode,
        point_type: pointType,
    ...
    emptyPointNames() {
      this.bookingTravel.selectedPointName = "";
    },
    calculateTravelkiloMeter() {
      this.TravelkiloMeter = Math.round(
        parseInt(
          this.travelcartRows.price *
            this.bookingTravel.selectedPointName.kiloMeter
        ).toFixed(2)
