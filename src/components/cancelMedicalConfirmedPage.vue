            ...
            <div class="row">
              ...
              <div class="q-pa-md">
                ...
                <p style="text-align: justify">
                 Thank You, Your Cancellation With {{ this.individual_medical_cancel_data[0].equipment_partner_sub_name }} Successfully Done.
                  <b>
                    <!-- {{ this.propBookedGuestNo[0].property_name }}
                         (Near
                      {{ this.propBookedGuestNo[0].near_hospital_name }}) --> </b
                  >Please Find below The Refunds Amount Details
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <div class="row justify-left col-12 q-mb-md q-pa-sm">
                ...
                <div class="col-6 text-right">
                  ...
                  >
                    <b
                      >MANGOHOMZ ID :
                      {{ this.individual_medical_cancel_data[0].booking_order_id }}
                    </b>
                  </p>
                  <p
                  ...
                  >
                    Medical Cancel on
                    {{ this.individual_medical_cancel_data[0].inserted_date }}
                  </p>
                </div>
              </div>
              ...
              >
                <div>
                  ...
                  <!-- Medical Refund  Details Start -->
                  <div
                    class="row justify-left col-9 q-mb-md"
                    v-show="
                      this.individual_medical_cancel_data.length <= 0 ? false : true
                    "
                  >
                    <p
                    ...
                    >
                      ...
                      <div
                        style="display:flex;width:100%; border-top:1px solid silver"
                      >
                        <div style="width:60%">
                          <div
                            class="text-subtitle"
                      ...
                      "
                        >
                          Rs.
                          {{ this.individual_medical_cancel_data[0].medical_charges }}
                        </div>
                      </div>
                      <div style="display:flex;width:100%;">
                        <div style="width:60%">
                      ...
                      "
                          >
                            MH offer (APPLY COUPEN)
                            {{ this.individual_medical_cancel_data[0].discount }}
                      ...
                      "
                        >
                          (-) Rs.
                          {{ this.individual_medical_cancel_data[0].discount_price }}
                        </div>
                      </div>
                      <!-- <div style="display:flex;width:100%;">
                        <div style="width:60%">
                      ...
                      "
                          >
                            Discount Price 15% :
                            {{ this.individual_medical_cancel_data[0].mh_offer_name }}
                          </div>
                        </div>
                        ...
                        >
                          (-) Rs.
                          {{ this.individual_medical_cancel_data[0].mh_offer_price }}
                        </div>
                      </div> -->
                      <!-- <div style="display:flex;width:100%;">
                        <div style="width:60%">
                      ...
                      "
                        ...
                        >
                          Rs.
                          {{ this.individual_medical_cancel_data[0].final_price_amount }}
                        </div>
                      </div> -->
                      <div style="display:flex;width:100%;">
                        <div style="width:60%">
                      ...
                      "
                        ...
                        >
                          <strong>
                            Rs.
                            {{ this.individual_medical_cancel_data[0].cgst_amount }}
                            /-
                          </strong>
                        </div>
                      </div>
                      ...
                      "
                        ...
                        >
                          <strong>
                            Rs.
                            {{ this.individual_medical_cancel_data[0].sgst_amount }}
                            /-
                          </strong>
                        </div>
                      </div>
                      ...
                      "
                        ...
                        >
                          <strong>
                            Rs.
                            {{
                              this.individual_medical_cancel_data[0]
                  ...
                  >
                    ...
                    >
                      <p
                        class="row col-12 text-bold q-mt-sm q-mb-xs"
                        style="font-size: 15px;font-family: verdana;padding-left:10px"
                      >
                        <b>Payment Refunds Details</b>
                      </p>

                      <p
                        style="font-size: 12px;font-family: verdana;padding-left:20px"
                      >
                        • The Amount Will be Created To The Linked Account Within 5 To 7 Bank Working Days.
                      </p>
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          style="display:flex;width:100%;text-align:center;padding-bottom:10px;"
                        >
                          <div
                            class="text-center"
                            style="text-align:center;padding-top:10px;width:10%;padding-left:10px;"
                          >
                            <img
                          ...
                          >
                            <div class="col-5">
                              <div
                                style="padding-left:50px;color:#1e398e;text-align:center;"
                              >
                                <u>Contact US</u>
                              </div>
                ...
                >
                  ...
                  >
                    <div class="col-12 row" style="display:flex">
                      <div
                        class="col-2"
                        style="width:60px; border-radius: 50%; background-color: #e4fae9;padding: 15px;margin:15px 10px 20px 40px;color:green"
                      >
                        <q-icon
                          size="40px"
                          name="mdi-domain"
                      ...
                      <div class="col-10 " style="color:white">
                        ...
                        <p>
                          <b
                            ...
                            {{ this.individual_medical_cancel_data[0].transport_sub_name }}
                            is confirmed.</b
                          > Please Find below The Refunds Amount Details
                        </p>
                      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        title1: "Travel Cancel Invoice Details",
        confirm: false,
        // GuestDetails: {
        //   guest_name: ""
        // },
    ...
    created() {
      this.propMedicalBookedGuestNo = "";
      // this.propCancelGuestNo = this.$route.params.guestCancelID;
        this.propMedicalBookedGuestNo = this.$route.params.medicalCanceldata;

      //console.log("this",  this.$route.params.medicalCanceldata);
    ...
    computed: {
      ...
      //   acc_guest_cancel_data: state => state.cancelled.acc_guest_cancel_data,
        individual_medical_cancel_data: state => state.cancelled.individual_medical_cancel_data,
    ...
    mounted() {
      ...
      // this.$store.dispatch(`cancelled/getIndividualTravelCancelId`, "2147483647");
      this.$store.dispatch(`cancelled/getIndividualMedicalCancelId`);


    },
    methods: {

     // ...mapActions("cancelled", ["getIndividualTravelCancelId"]),
