<template>
  <q-page-container class="bg-indigo-1">
        ...
        <div class="q-pa-md row justify-center q-gutter-md">
                ...
                <div class="row col-12">
                  ...
                  >
                    <div>
                      ...
                      <q-img src="~assets/logos/Sold outt.webp"></q-img>
                      ...
                      <div class="row col-12">
                        ...
                        >
                          <strong>{{
                            this.propBookingRoomData[0].sub_property_name
                          }}</strong>

                          ({{ this.propBookingRoomData[0].property_name }})
                          <div
                            class="text-caption"
                            style="font-family: verdana; font-size: 11px"
                          >
                            {{ this.propBookingRoomData[0].address[0].address }}
                          </div>
                          <div
                            class="text-caption"
                            style="font-family: verdana; font-size: 11px"
                          ...
                          <strong>{{
                            this.propBookingRoomData[0].room_category
                          }}</strong>
                          ({{ this.propBookingRoomData[0].room_type }})
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div v-else>
            <q-card flat :class="class_val" class="bg-white">
              ...
              <div class="row">
                <div class="text-h6 text-bold q-pa-sm">Booking Details</div>
                <q-space />
              </div>
              <q-separator />

              <q-card class="row">
                <q-card-section horizontal class="col-3">
                  <q-img
                    class="col-12 q-my-sm q-ml-md"
                    :src="`${hotelImgpath}${this.propBookingRoomData[0].upload_image}`"
                    style="height: 230px"
                  />
                </q-card-section>
                <q-card-section class="col-8 q-ml-xl">
                  <div>
                    <q-icon>
                      <q-img
                        src="~assets/logos/MHmini_logo_128x128.png"
                  ...
                  <div class="row col-12">
                    <div class="col-3" style="width: 5px; height: 100px">
                      <div style="margin-left: 460px; z-index: -10px">
                        <img
                          style="width: 200px; margin-top: 0px; cursor: pointer"
                          @click="handleCustomEvent(`${redcliffpath}`)"
                    ...
                    >
                      ...
                      >
                        ...
                        <span class="text-bold"
                          ><strong
                            >{{ this.searchItem.city.city_name }}, India</strong
                          ></span
                        >
                      </div>
                      ...
                      ({{ this.propBookingRoomData[0].room_type }}) <br />Room
                      Price: ₹<strong
                        class="text-grey"
                        style="font-family: verdana; font-size: 16px"
                        ><s
                          ...
                          <!-- {{
                        searchItem.adult_count >= 3
                          ? 2 * this.propBookingRoomData[0].price
                          : this.propBookingRoomData[0].price
                      }} -->
                        </s></strong
                      >
                      MangoHomz Price ₹<strong
                      ...
                      searchItem.adult_count >= 3
                        ? 2 *
                          (this.propBookingRoomData[0].price -
                            ...
                            this.mangohomzOffers_arr1[0].offer_price)
                        : this.propBookingRoomData[0].price -
                          parseInt(
                            this.propBookingRoomData[0].price *
                              (this.propBookingRoomData[0]
                      ...
                      <span style="font-family: verdana; font-size: 14px">
                        {{
                          searchItem.adult_count === 1
                            ? ` For ${this.days} Nights, 1 Room`
                            : searchItem.adult_count === 2
                            ? `For ${this.days} Nights, 1 Room`
                            : searchItem.adult_count === 3
                            ? `For ${this.days} Nights, 1 Room`
                            : searchItem.adult_count >= 4
                            ? `For ${this.days} Nights, 2 Rooms`
                            : this.days
                        }}
                      </span>

                      <!--
                    MangoHomz Price ₹<strong>{{this.propBookingRoomData[0].price -
                      parseInt(
                        this.propBookingRoomData[0].price *
                          (this.propBookingRoomData[0].partner_specialOffer /
                            100)
                      ) -
                      parseInt(
                        (this.propBookingRoomData[0].price *
                          this.propBookingRoomData[0].property_specialOffer) /
                          100
                      ) -
                      this.mangohomzOffers_arr1[0].offer_price
                    }}</strong>
                    <span style="font-family: verdana; font-size: 12px">
                      {{ this.propBookingRoomData[0].units }}</span
                    > -->
                    </div>
                    <!-- <div
                    class="text-h6 col-3"
                  ...
                  >
                    Rs.
                    <strong>{{ this.propBookingRoomData[0].price }}</strong>
                    <span style="font-family: verdana; font-size: 12px">
                      {{ this.propBookingRoomData[0].units }}</span
                    >
                  </div> -->
                  ...
                  <div class="row q-pa-sm" style="background-color: #e4fae9">
                    <div class="col-4">
                      <div
                        class="text-caption"
                      ...
                      >
                        {{
                          moment(
                            propBookingRoomData[0].checkIn_time,
                            "HH:mm"
                          ).format("HH:mm a")
                        }}
                      </div>
                    ...
                    <div class="col-4">
                      ...
                      >
                        {{
                          moment(
                            propBookingRoomData[0].checkOut_time,
                            "HH:mm"
                          ).format("HH:mm a")
                        }}
                      </div>
                    ...
                    <div class="col-4">
                      ...
                      <div
                        ...
                        style="font-family: verdana; font-size: 10px"
                      >
                        Adults: {{ this.searchItem.adult_count }}, Kids:
                  ...
                  <div class="col-12 q-mt-sm">
                    <div class="row q-pa-sm" style="background-color: #e4fae9">
                      <div class="q-pa-xs">
                        ...
                        >
                          <span
                            v-for="item in searchItem.adult_count"
                            :key="item.id"
                          >
                            <q-icon name="mdi-account" size="15px" />
                          </span>
                          {{ this.searchItem.adult_count }} Adults &
                          <span
                            v-for="item in searchItem.child_count"
                            :key="item.id"
                          >
                            <q-icon name="mdi-human-child" size="15px" />
                          </span>
                          {{ this.searchItem.child_count }} kids
                        </div>
                        <div
                          class="col-12 text-primary text-caption"
                          style="font-family: verdana; font-size: 10px"
                        >
                          <q-icon size="80px"
                            ><q-img
                              src="~assets/web_site/Early Bird Offer (1).webp"
                            ></q-img
                          ></q-icon>
                          Great Choice. Mangohomz Discount. You are saving Rs
                          {{ this.discount }} with your booking
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <q-card flat :class="class_val" class="row bg-transparent">
              <div class="q-pa-xs">
                <div class="bg-white row col-12 q-pa-md">
                  <div class="row col-12 q-pa-xs">
                    <div
                      class="row col-12 text-bold q-mb-sm"
                    ...
                    >
                      <q-select
                        ...
                        hide-bottom-space
                        style="width: 110px"
                        class="col-3 q-mr-sm q-mb-xs"
                        label-color="black"
                        :rules="[required('Country Code')]"
                      ...
                      <q-input
                        ...
                        filled
                        outlined
                        v-model="bookingForm.primary_no"
                        ...
                        style="width: 220px"
                        label-color="black"
                        :rules="[required('Primary Contact Number'), phone()]"
                        ref="verifyMobile"
                      >
                    ...
                    ></q-input> -->
                      <q-input
                        ...
                        outlined
                        filled
                        v-model="bookingForm.email_id"
                        label="Primary Email ID *"
                        :rules="[required('Primary Email ID'), email()]"
                        style="width: 220px"
                        hide-bottom-space
                        label-color="black"
                      ></q-input>
                      ...
                      <q-input
                        ...
                        filled
                        outlined
                        v-model="bookingForm.alternate_no"
                        label="Alternate Contact No "
                        lazy-rules
                        mask="##########"
                        style="width: 220px; padding-left: 7px"
                        class="col-3 q-mr-sm q-mb-xs"
                        label-color="black"
                      >
                        <template v-slot:prepend>
                    ...
                    ></q-input> -->
                      <q-input
                        ...
                        outlined
                        filled
                        v-model="bookingForm.alternate_email_id"
                    ...
                    <q-form
                      ref="addressForm"
                      class="row col-12 items-start q-gutter-md"
                    >
                      <q-input
                        class="col-3"
                        dense
                        outlined
                        filled
                        v-model="bookingForm.address_line1"
                      ...
                      <q-input
                        ...
                        outlined
                        filled
                        v-model="bookingForm.address_line2"
                        label="Address Line 2 *"
                        :rules="[required('Address Line 2')]"
                        style="width: 180px"
                        hide-bottom-space
                        label-color="black"
                      ></q-input>
                    ...
                    >
                      <q-select
                        v-model="guestFormDetails.addressingGuest"
                        class="col-1"
                        :options="['Mr.', 'Ms.', 'Mrs.', 'Master']"
                        filled
                        square
                        dense
                        style="width: 90px"
                    ...
                    <div
                      class="row col-12 q-pa-md"
                      v-if="this.guestTypeData.length > 0"
                    >
                      <q-table
                        :data="guestTypeData"
            ...
            <q-card flat :class="class_val" class="row bg-transparent">
              <div
                ...
                style="max-width: 402px; height: 450px"
              >
                <div class="row col-12">
                  <div
                ...
                >
                  <q-list dense style="font-size: 11px" class="row col-12">
                    <q-item class="col-12 text-bold">
                      <q-item-section>Room Charges</q-item-section>
                      <q-space />
                      <q-item-section class="text-right"
                        >₹{{ this.roomCharges }}</q-item-section
                      >
                    </q-item>
                    <q-item class="col-12 text-bold">
                      <q-item-section>Partner Offer</q-item-section>
                      <q-space />
                      <q-item-section class="text-right"
                        >(-) ₹{{ this.partneroffer }}</q-item-section
                      >
                    </q-item>
                    <!-- <q-item class="col-12">
                    <q-item-section>Early Bird Offer</q-item-section>
                    <q-space />
                    <q-item-section class="text-right"
                    ...
                    <q-item class="col-12 text-bold">
                      <q-item-section style="color:purple; font-size: 11px">Mangohomz Discount</q-item-section>
                      <q-space />
                      <q-item-section class="text-right"  style="color:purple;"
                    ...
                    <q-item class="col-12 text-bold">
                      ...
                      <!-- <q-item-section
                      >GST @
                      {{ this.propBookingRoomData[0].gst_per }}%</q-item-section
                    > -->
                      <q-item-section class="text-right"
                        >₹{{ parseInt(this.gstOnbasicPrice) }}
                      </q-item-section>
                      <q-space />
                    </q-item>
                    <!-- <q-item class="col-12">
                    <q-item-section
                      >CGST on price ({{
                        parseInt(this.propBookingRoomData[0].gst_per) / 2
                      }})%</q-item-section
                    >
                    <q-space />
                    <q-item-section class="text-right"
                      >Rs {{ parseInt(this.gstOnbasicPrice / 2) }}
              ...
              >
                ...
                <div
                  ...
                  v-if="propBookingRoomData[0].mhofferstatus === 'yes'"
                >
                  <q-list
                    dense
                    style="font-size: 11px"
                    class="cursor-pointer row col-12"
                    v-for="item in mangohomzOffers_arr1"
                    :key="item.sno"
                  >
                    <q-card
                      v-if="
                        roomCharges >= item.offer_money_start &&
                        roomCharges <= item.offer_money_end
                      "
              ...
              >
                ...
                <div class="row col-12 q-gutter-md q-mb-md">
                  ...
                  <div
                    class="col-11 text-bold text-grey"
                    style="font-size: 11px; text-align: center"
                  >
                    Invoice & Payment details will be sent to the registered
                    email
                  </div>
                </div>
                <q-separator />
                ...
                <div class="q-mt-md">
                  <q-input
                    ...
                    filled
                    outlined
                    v-model="bookingForm.gstin_no"
                    v-if="this.gst_checkbox == true"
                    class="q-mx-auto"
                ...
                <div class="row justify-center">
                  <q-btn
                    ...
                    @click="proceedToPay(propBookingRoomData[0])"
                  />
                </div>
              </div>
            </q-card>
      ...
      <q-dialog v-model="grievanceDialog">
        <q-card style="min-width: 350px">
          ...
          <q-card-section class="q-pt-none">
            <q-form class="q-gutter-md" ref="grievanceForm">
              <q-input
                dense
                outlined
        ...
        <q-card style="min-width: 350px">
          ...
          <q-card-section>
            ...
            >
              ...
              MangoHomz Guests to receive a full refund if they cancel
              Accommodation booking at least 3 days before the check-in date.
              Any cancellation thereafter till check-in the guest will be
              entitled to get only 60% refund after all necessary tax deductions
              applicable. Once checked in there is no cancellation.
            </div>
          </q-card-section>
        </q-card>
      </q-dialog>
    ...
    <q-page style="margin-top: 80px; padding: 0px" class="lt-sm">
      <div class="justify-center">
        <div
        ...
        >
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        <div class="row col-12" style="margin-right: 10px">
                          <div
          ...
          <div v-else>
            <q-card flat :class="class_val" class="bg-white">
              <q-toolbar class="my-breadcrumbs row bg-white rounded-borders">
                ...
                >
                  ...
                  >
                  <q-breadcrumbs-el icon="hotel" @click="goToHotelInformation"
                    ><q-tooltip>
                      Hotel Information
                  ...
                  <q-breadcrumbs-el
                    ...
                    class="text-bold text-h6"
                    to="/cartDetails"
                    ><q-tooltip> Cart Details </q-tooltip></q-breadcrumbs-el
                  >
                </q-breadcrumbs>
                <q-space />
                <!-- <q-btn
              ...
              <div class="row">
                <div class="col-12 q-ml-xs bg-white" style="padding-left: 10px">
                  <img
              ...
              <q-card class="row">
                ...
                >
                  <q-img
                    class="col-12 q-my-sm q-ml-sm"
                    :src="`${hotelImgpath}${this.propBookingRoomData[0].upload_image}`"
                    style="height: 230px"
                  />
                </q-card-section>
                <q-card-section class="col-12 q-ml-xl" style="margin-left: 1px">
                  <div>
                    <q-icon>
                      <q-img
                        src="~assets/logos/MHmini_logo_128x128.png"
                  ...
                  <div class="row col-12" style="margin-right: 10px">
                    ...
                    >
                      ...
                      {{
                        searchItem.adult_count >= 3
                          ? `${this.propBookingRoomData[0].units} For 2 Rooms`
                          : this.propBookingRoomData[0].units
                      }}</span
                    > -->
                    </div>
                    <!-- <div
            ...
            <q-card flat :class="class_val" class="row bg-transparent">
              <div
                class="col-12 q-ml-xs bg-white"
                style="max-width: 402px; height: 150px"
              >
                <div class="row col-12">
                  <div
                    class="text-caption text-bold q-pa-sm text-silver"
              ...
              >
                ...
                >
                  <q-list dense style="font-size: 11px" class="row col-12">
                    ...
                    <q-item class="col-12 text-bold">
                      <q-item-section  style="color:purple;font-size: 13px ">Mangohomz Discount</q-item-section>
                      <q-space />
                      <q-item-section class="text-right"  style="color:purple;"
                        >(-) ₹{{ this.discount }}</q-item-section
                      >
...
export default {
  ...
  data() {
    return {
      ...
      guest_item: "Enter All Guests Details",
      guestcounts: 1,
      guestTypeData: [],
      guestFormDetails: {
        property_email: "",
      ...
      guestColumns: [
        ...
        // },
        {
          name: "guest_name",
          label: "Guest Name",
          field: (row) => row.guest_gender + " " + row.guest_name,
          // field: "guest_name",
          align: "center",
        },
        // {
  ...
  created() {
    // this.propBookingRoomData = [];
    this.propDetails = [];
    // this.propBookingRoomData.push(this.$route.params.bookingRoomInfo);
    // this.propBookingRoomData.push(JSON.parse(this.$route.params.bookingRoomInfo));
    this.propDetails.push(JSON.parse(this.$route.params.bookingRoomInfo));
    // console.log("this.propDetails3",this.propDetails)
    // this.propBookingRoomData.push(this.hotel_arr_forcart[0]);
    //  console.log("createddatas", this.propBookingRoomData);
  ...
  computed: {
    ...mapState({
      // hotel_arr_forcart: (state) => state.booking.hotel_arr_forcart,
      hotelInfo_arr: (state) => state.booking.hotelInfo_arr,
      mangohomzOffers_arr1: (state) => state.booking.mangohomzOffers_arr,
    ...
    roomCharges() {
      let roomCharges = Math.round(parseInt(this.room_total));
      return roomCharges;
    },
    discount() {
      let discount = Math.round(
        (parseInt(this.basicPrice) *
          parseInt(this.propBookingRoomData[0].property_specialOffer)) /
          100
      );
      return discount;
    },
    ...
    partneroffer() {
      let partnerOffer = Math.round(
        parseInt(
          this.room_total *
            (this.propBookingRoomData[0].partner_specialOffer / 100)
        )
      );
      return partnerOffer;
    },
    ...
    // basicPrice() {
    //   let basicPrice = Math.round(
    //     parseFloat(this.room_total).toFixed(2) -
    //       (parseFloat(this.room_total).toFixed(2) *
    //         parseInt(this.propBookingRoomData[0].property_specialOffer)) /
    //         100
    //   ).toFixed(2);
    ...
    gstOnbasicPrice() {
      let gstbasicPrice = Math.round(
        (this.basicPrice * parseInt(this.propBookingRoomData[0].gst_per)) / 100
      );
      return gstbasicPrice;
    },
    ...
    //         parseInt(this.propBookingRoomData[0].property_specialOffer)) /
    //         100
    //   ).toFixed(2) * this.propBookingRoomData[0].gst_per/100;
    //   return parseInt(gstbasicPrice)/2;
    // },

    priceAfterDiscount() {
      let priceAfterDisc = Math.round(
        parseInt(
          this.basicPrice - parseFloat(this.selected_offer_price).toFixed(2)
        ).toFixed(2) - parseInt(this.discount)
      );
    ...
    payableAmount() {
      let payAmount = Math.round(
        parseInt(this.priceAfterDiscount + parseInt(this.gstOnbasicPrice))
      );
      return payAmount;
    },
    // payableAmount() {
    ...
    //   return payAmount;
    // },
    ...mapGetters("booking", ["hotel_arr_forcart"]),
  },
  async mounted() {
    ...
    try {
      const data = await this.someFunction(this.propDetails);
      this.propBookingRoomData.push(data.data[0]);
      //  console.log("cartDetails:", data, this.propBookingRoomData[0].no_of_avail_rooms);

      if (this.propBookingRoomData[0].no_of_avail_rooms == 0) {
        if (this.propBookingRoomData[0].no_of_avail_rooms == 0) {
          this.roomIsSoldOut = true;
        } else {
          this.roomIsSoldOut = false;
        }

        // console.log("cartDetails:", this.propDetails);
        // console.log("this",this.searchItem)
        // this.$router.push({
        //   name: "Hotel Information",
        //   params: {
        //     hotelInfo: JSON.stringify({
        //       partner_id: this.propDetails[0].partner_id,
        //       partner_sub_id: this.propDetails[0].partner_sub_id,
        //       txn_id: this.propDetails[0].single_txn,
        //     }),
    ...
    //  console.log("3rdpage",this.propBookingRoomData);
    // let hotelSerachDetails =
    //   JSON.parse(localStorage.getItem("searchItem")) || [];

    this.$store.dispatch("booking/getMangohomzOfferData");
    // this.$store.dispatch(`booking/loadHotelInfoForCart`, this.propDetails);
    // console.log("ssssssssss",this.hotel_arr_forcart[0])

    this.total_guests_count = parseInt(
    ...
    //console.log("sasaaa", this.days);

    this.$store.dispatch(`booking/loadHotels`, this.searchItem);
    this.room_total =
      (this.searchItem.adult_count >= 4
        ? 2 * this.propBookingRoomData[0].price
        : this.propBookingRoomData[0].price) * this.days;
    this.cart_total = this.room_total;
    this.$store.dispatch("dropdown/loadAllStates");
  },
  methods: {
    ...mapActions("booking", ["getMangohomzOfferData"]),
    ...mapActions("booking", ["saveBookingData"]),
    ...mapActions("booking", ["bookingDataSavingBeforePay"]),
    ...
    async fetchData(payload) {
      try {
        const response = await api.get(
          `/hotelManagement/loadHotelInfoForCart/${payload?.[0].partner_id}/${payload?.[0].partner_sub_id}/${payload?.[0].txn_id}`
        );
    ...
    async someFunction(payload) {
      try {
        const response = await this.fetchData(payload);
        // console.log("consolcart", response);
        return response;
      } catch (error) {
        console.error(error);
        throw error;
    ...
    noOfDays(date1, date2) {
      //console.log("number of days",date1,date2)
      //2023/03/31 2023/04/02
      date1 = date1.split("/");
      date2 = date2.split("/");
      var newdate1 = date1[0] + "-" + date1[1] + "-" + date1[2];
      var newdate2 = date2[0] + "-" + date2[1] + "-" + date2[2];
      //console.log("dddd ",newdate1,newdate2);
      const newdate11 = new Date(newdate1);
      const newdate22 = new Date(newdate2);
      ...
      this.$refs.guestForm.validate().then((valid) => {
        if (!valid) {
          this.$q.notify({
            position: "top",
            color: "negative",
            message: "Please Fill the Patient/Guest Details",
          });
        } else {
          if (
            ...
            if (this.guestTypeData.length >= this.total_guests_count) {
              this.$q.notify({
                position: "top",
                color: "negative",
                message: `Sorry! You have Already Selected ${this.guestTypeData.length} Guests for Booking. To Add an additional guest, Please add guests in the above Search Button.`,
              });
            } else {
              if (this.guestTypeData.length != this.total_guests_count) {
                this.guestcounts = this.guestTypeData.length + 2;
                if (this.guestTypeData.length == this.total_guests_count - 1) {
                  this.guestcounts = this.total_guests_count;
                }
              }

              if (this.guestTypeData.length == 0) {
                this.bookingForm.phone = this.bookingForm.primary_no;
                var guestObj = {
                  sno: this.guestTypeData.length + 1,
                  first_name: this.guestFormDetails.first_name,
                  last_name: this.guestFormDetails.last_name,
                  addrssing_guest: this.guestFormDetails.addressingGuest,
                  guest_name: `${this.guestFormDetails.first_name} ${this.guestFormDetails.last_name}`,
                  guest_gender: this.guestFormDetails.addressingGuest,
                  guest_type: `Guest ${
                    parseInt(this.guestTypeData.length) + 1
                  }`,
                };
                this.guestTypeData.push(guestObj);
                this.guestFormDetails.first_name = "";
                this.guestFormDetails.last_name = "";
                this.guest_item = `Enter Guest ${this.guestcounts}  / ${this.total_guests_count} Details`;
              } else {
                var guestObj = {
                  sno: this.guestTypeData.length + 1,
                  first_name: this.guestFormDetails.first_name,
    ...
    removeCoupon() {
      this.selected_offer_name = "APPLY OFFER";
    ...
    deleteItem(item) {
      ...
      this.$q.notify("The Selected Guest Details are been deleted!");
      this.guest_item = `Enter Guest ${this.guestTypeData.length + 1} / ${
        this.total_guests_count
      } Details`;
      if (this.guestTypeData.length == 0) {
        this.guest_item = "Enter All Guests Details";
      }
    },
    proceedToPay(roomData) {
            ...
            if (success) {
              if (this.guestTypeData.length == this.total_guests_count) {
                this.$q
                  .dialog({
                    title: "Confirm",
                    message: "Do you want to Proceed for the Payment ?",
                    cancel: true,
                    persistent: true,
                  })
                  .onOk(() => {
                    this.guestFormDetails.account_id = roomData.account_id;
                    this.guestFormDetails.partner_id = roomData.partner_id;
                    this.guestFormDetails.partner_name = roomData.partner_name;
                    this.guestFormDetails.partner_sub_id =
                      roomData.partner_sub_id;
                    this.guestFormDetails.partner_sub_name =
                      roomData.sub_partner_name;
                    this.guestFormDetails.property_txn_id =
                      roomData.property_txn_id;
                    this.guestFormDetails.property_name =
                      roomData.sub_property_name;
                    this.guestFormDetails.property_type =
                      roomData.property_name;
                    this.guestFormDetails.room_txn_id = roomData.txn_id;
                    this.guestFormDetails.room_type = roomData.room_type;
                    this.guestFormDetails.near_hospital_id =
                      this.searchItem.hospital.near_hospital_id;
                    this.guestFormDetails.near_hospital_name =
                      this.searchItem.hospital.near_hospital_name;
                    this.guestFormDetails.check_in = this.searchItem.checkIn;
                    this.guestFormDetails.check_out = this.searchItem.checkOut;
                    this.guestFormDetails.checkIn_time =
                      this.propBookingRoomData[0].checkIn_time;
                    this.guestFormDetails.checkOut_time =
                      this.propBookingRoomData[0].checkOut_time;
                    this.guestFormDetails.facilities =
                      this.propBookingRoomData[0].facilities;
                    this.guestFormDetails.total_price = this.payableAmount;
                    this.guestFormDetails.phone_no = this.bookingForm.phone;
                    this.guestFormDetails.usedOffer_name =
                      this.selected_offer_name == "APPLY COUPON"
                        ? ""
                        : this.selected_offer_name;
                    this.guestFormDetails.usedOffer_price =
                      this.selected_offer_price;
                    this.guestFormDetails.room_price = this.roomCharges;
                    this.guestFormDetails.discount = parseInt(
                      this.propBookingRoomData[0].property_specialOffer
                    );
                    this.guestFormDetails.discount_price = this.discount;
                    this.guestFormDetails.price_after_discount =
                      this.priceAfterDiscount;
                    this.guestFormDetails.gst_amount = this.gstOnbasicPrice;
                    this.guestFormDetails.partner_offer_percentage =
                      this.propBookingRoomData[0].partner_specialOffer;
                    this.guestFormDetails.partner_offer = this.partneroffer;
                    this.guestFormDetails.base_price = this.basicPrice;

                    this.guestFormDetails.gst_percentage =
                      this.propBookingRoomData[0].gst_per;
                    this.guestFormDetails.cgst_amount = parseInt(
                      this.gstOnbasicPrice / 2
                    );
                    this.guestFormDetails.cgst_percentage =
                      parseInt(this.propBookingRoomData[0].gst_per) / 2;
                    this.guestFormDetails.sgst_amount = parseInt(
                      this.gstOnbasicPrice / 2
                    );
                    this.guestFormDetails.sgst_percentage =
                      parseInt(this.propBookingRoomData[0].gst_per) / 2;
                    this.guestFormDetails.no_of_days = this.days;
                    this.guestFormDetails.guestDataObj = this.guestTypeData;
                    this.guestFormDetails.property_city_id = roomData.city_id;
                    this.guestFormDetails.property_city_name =
                      roomData.city_name;
                    this.guestFormDetails.property_state_id = roomData.state_id;
                    this.guestFormDetails.property_state_name =
                      roomData.state_name;
                    this.guestFormDetails.primary_no =
                      this.bookingForm.primary_no;
                    this.guestFormDetails.selected_country =
                      this.guestFormDetails.selected_country;
                    this.guestFormDetails.email_id = this.bookingForm.email_id;
                    this.guestFormDetails.alternate_no =
                      this.bookingForm.alternate_no;
                    this.guestFormDetails.alternate_email_id =
                      this.bookingForm.alternate_email_id;
                    this.guestFormDetails.address_line1 =
                      this.bookingForm.address_line1;
                    this.guestFormDetails.address_line2 =
                      this.bookingForm.address_line2;
                    this.guestFormDetails.city = this.bookingForm.city;
                    this.guestFormDetails.state_id =
                      this.bookingForm.state.state_id;
                    this.guestFormDetails.state =
                      this.bookingForm.state.state_name;
                    // console.log("ddd",this.bookingForm)
                    // if (this.bookingForm.country == "India") {
                    //   console.log("ddd",this.bookingForm)
                    //   this.guestFormDetails.state =
                    //     this.bookingForm.state.state_name;
                    //   this.guestFormDetails.state_id =
                    //     this.bookingForm.state.state_id;
                    // } else {
                    //   this.guestFormDetails.state = this.bookingForm.state1;
                    // }

                    this.guestFormDetails.country =
                      this.bookingForm.country.name;
                    this.guestFormDetails.pincode = this.bookingForm.pincode;
                    this.guestFormDetails.gstin_no = this.bookingForm.gstin_no;
                    this.guestFormDetails.property_email =
                      this.propBookingRoomData[0].property_email;
                    this.guestFormDetails.property_phone =
                      this.propBookingRoomData[0].property_phone;
                    this.guestFormDetails.property_alternate_email =
                      this.propBookingRoomData[0].property_alternate_email;


                      this.guestFormDetails.gst_status =
                      this.propBookingRoomData[0].getgstdata;

                      this.guestFormDetails.mh_service_fee =
                      this.propBookingRoomData[0].mh_service_fee;

                    this.guestFormDetails.room_category =
                      this.propBookingRoomData[0].room_category;
                    this.guestFormDetails.address =
                      this.propBookingRoomData[0].address[0].address;
                    if (this.searchItem.adult_count >= 4) {
                      this.guestFormDetails.room_booked_count = "2";
                    } else {
                      this.guestFormDetails.room_booked_count = "1";
                    }

                    // this.guestFormDetails.browser_name = navigator.userAgentData.brands[2].brand;
                    let bookingGuestsData = this.guestFormDetails;
                    // console.log("frontendData", bookingGuestsData);

                    this.showRazorpay(bookingGuestsData);
                  });
              } else {
                this.$q.notify({
                  color: "negative",
                  position: "top",
                  message: `Please Add ${
                    parseInt(this.total_guests_count) -
                    parseInt(this.guestTypeData.length)
                  } More Guest Details to Continue`,
                });
              }
            }
          });
    ...
    async showRazorpay(item) {
      this.bookingDataSavingBeforePay(item);
      let paymentObj = {
      ...
      api
        .post("/razorPayPayment/payAmount", paymentObj)
        .then((response) => {
    ...
    checkstate() {
      // this.bookingForm.country.name = this.propBookingRoomData[0].country;
      if (this.bookingForm.country.name == "India") {
    ...
    emptyotherstate() {
      this.bookingForm.city = [];
      this.bookingForm.state = [];
    },
    onGrievanceSubmit() {
