          ...
          >
            ...
            <q-card-section padding style="padding-top:20px;">
              ...
              >
                ...
                />
                <span
                  >You save Rs 999 with<span
                    class="text-secondary q-ml-xs text-bold"
                    >{{ this.travelBookingGuestData[0].usedOffer }}</span
                  ></span
                >
              </q-item>
            </q-card-section>
            ...
            <div style="text-align:center">
              <q-chip
                ...
                >PAY  Rs. {{travelBookingGuestData[0].payable_amount}}</q-chip
              >
              <!-- <q-btn
                class="text-center text-bold"
                dense
...
export default {
  ...
  created() {
    this.travelBookingGuestData = [];
    this.travelBookingGuestData.push(this.$route.params.travelbookingdata);
  },
  computed: {
    ...mapState({
  ...
  methods: {
    ...
    payTotalAMount() {
      this.submittravelDetails(this.travelBookingGuestData[0]);
