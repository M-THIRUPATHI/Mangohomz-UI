  ...
  <q-card-section class="text-white bg-primary">
    ...
    <div class="row lt-sm" style="margin-right: 15px">
      ...
      <div class="col-12 col-md-3">
        ...
        <div style="font-family: verdana" class="text-center">
          Address:<br />302, Cauvery Serenity, Yeshwanthpur, Bangalore<br />
          INDIA – 560022
        </div>
      </div>
      ...
      <div class="col-12">
        ...
        <div style="font-family: verdana" class="text-center">
          <br />Copyright © MANGOHOMZ TECHNOLOGIES PRIVATE LIMITED. All
          rights reserved.<br />
        </div>
      </div>
    </div>
    <div class="row gt-xs">
      ...
      <div class="col-12 col-md-3">
        <div
          ...
          style="font-family: verdana; margin-left: -160px"
        >
          FOLLOW US ON
        </div>
        <div>
          <div class="row">
            <div class="col-md-3 q-pa-md" style="margin-right: -30px">
              <q-btn
                href="https://www.facebook.com/mangohomzpage"
                aria-label="MH FaceBook Communication Link"
                target="_blank"
      ...
      <div class="col-6 col-md-2" style="margin-left: 130px;">
        <div
      ...
      <div class="col-12 col-md-2" style="margin-left: 131px;">
        <div
          class="footer-head text-bold"
          style="font-family: verdana; margin-top: -4px"
        >
          BUSINESS HOURS
        </div>
        <div style="font-family: verdana">
    ...
    <q-dialog v-model="staffLoginDialog">
      <q-card style="min-width: 350px">
        <q-card-section>
          <div
            class="footer-head text-bold text-left"
            style="font-family: verdana; margin-left: 10px; margin-top: -2px"
          >
            MH LOGIN
          </div>
          <div class="text-h6 text-bold text-primary">
