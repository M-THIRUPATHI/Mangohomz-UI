              ...
              <div class="col-6" style="width: 500px;">
                <q-card style="padding: 10px; margin: 5px"  class="cursor-pointer"  @click="navigateTopartnerRegApproval()">
                  <a
                    ...
                    >1.  Partner Registration Approval</a
                  ><p style="font-size: 12px;"> Partner Approval Process Data.</p>
                </q-card>
                <q-card style="padding: 10px; margin: 5px" class="cursor-pointer"  @click="navigateToagentRegApproval()">
                  <a
                    class="text-bold text-primary "

                    >2.  Agent Registration Approval</a
                  ><p style="font-size: 12px;"> Agent Approval Process Data.</p>
                </q-card>
                <q-card style="padding: 10px; margin: 5px" class="cursor-pointer"  @click="navigateTostaffManagerApproval()">
                  <a
                    ...
                    >3.  Staff Approval</a
                  ><p style="font-size: 12px;"> Staff Approval Process Data.</p>
                </q-card>
                <q-card style="padding: 10px; margin: 5px" class="cursor-pointer" @click="navigateTocityManagerApproval()">
                  <a class="text-bold text-primary "
                    >4.  City Approval</a
                  ><p style="font-size: 12px;"> City Approval Process Data.</p>
                </q-card>
              </div>
              <div class="col-6" style="width: 500px;">
                <q-card style="padding: 10px; margin: 5px" class="cursor-pointer"  @click="navigateTopropertyPartnerRegApproval()">
                  <a
                    ...
                    >5.  Accommodation Approval</a
                  ><p style="font-size: 12px;"> Accommodation Approval Process Data.</p>
                </q-card>
                <q-card style="padding: 10px; margin: 5px" class="cursor-pointer"  @click="navigateTotransportPartnerRegApproval()">
                  <a
                    class="text-bold text-primary"

                    >6.  Travel Approval</a
                  ><p style="font-size: 12px;"> Travel Approval Process Data.</p>
                </q-card>
                <q-card style="padding: 10px; margin: 5px" class="cursor-pointer"  @click="navigateTofoodPartnerRegApproval()">
                  <a
                    class="text-bold text-primary "

                    >7.  Food Approval</a
                  ><p style="font-size: 12px;"> Food Approval Process Data.</p>
                </q-card>
                <q-card style="padding: 10px; margin: 5px" class="cursor-pointer" @click="navigateToequipmentPartnerRegApproval()">
                  <a
                    class="text-bold text-primary "

                    >8.  Medical Approval</a
                  ><p style="font-size: 12px;"> Medical Approval Process Data.</p>
                </q-card>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    navigateTopartnerRegApproval() {
      this.$router.push("/partnerRegApproval");
    },

    navigateToagentRegApproval() {
      this.$router.push("/agentRegApproval");
    },
    navigateTocityManagerApproval() {
      this.$router.push("/cityManagerApproval");
    },
    navigateTostaffManagerApproval() {
      this.$router.push("/staffManagerApproval");
    },

    navigateTopropertyPartnerRegApproval() {
      this.$router.push("/propertyPartnerRegApproval");
    },
    navigateTotransportPartnerRegApproval() {
      this.$router.push("/transportPartnerRegApproval");
    },
    navigateTofoodPartnerRegApproval() {
      this.$router.push("/foodPartnerRegApproval");
    },

    navigateToequipmentPartnerRegApproval() {
      this.$router.push("/equipmentPartnerRegApproval");
    },
  },
};
</script>
