<template>
  <div>
    ...
    <q-page style="padding-top: 130px" class="q-pa-md">
      <div class="q-pa-md">
        <q-chip square clickable @click="getEquipmentRegistrationMaster">
        ...
        <q-chip
          square
          clickable
          @click="getEquipmentRegistrationBasedOnStatus('approved')"
        >
        ...
        <q-chip
          square
          clickable
          @click="getEquipmentRegistrationBasedOnStatus('verified')"
        >
          <q-avatar color="primary" text-color="white">{{
            this.equipment_partner_registration_status_count.length == 0
              ? "0"
        ...
        <q-chip
          square
          clickable
          @click="getEquipmentRegistrationBasedOnStatus('rejected')"
        >
        ...
        <q-chip
          square
          clickable
          @click="getEquipmentRegistrationBasedOnStatus('pending')"
        >
      ...
      <q-dialog v-model="addDataDialog" persistent maximized>
        <q-card>
          ...
          <q-stepper v-model="step" color="primary" animated done-color="secondary" active-color="primary" inactive-color="primary">
            <q-step
              :name="1"
              title="Basic Details"
              icon="settings"
              ...
              <q-form ref="agentFormAddress">
                <div class="q-pa-md row q-gutter-md items-start">
                  ...
                  <q-input
                    ...
                    label="Pincode *"
                    label-color="black"
                    :rules="[required('Pin Code'), pinNumber()]"
                    ><template v-slot:prepend>
                      <q-icon
                        name="mdi-map-marker"
                        color="secondary"
              ...
              <q-form ref="agentFormBasic">
                <div class="q-pa-md row q-gutter-md">
                  <q-input
                    ...
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.name"
                    label="Equipment Partner Name *"
                    hide-bottom-space
                    style="width: 250px"
                    label-color="black"
                  ...
                  <q-input
                    ...
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.phone"
                    label="Phone *"
                    lazy-rules
                    mask="##########"
                    style="width: 250px"
                  ...
                  <q-input
                    ...
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.fax"
                    lazy-rules
                    mask="##########"
                    label="WhatsApp No *"
                    style="width: 250px"
                  ...
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.email_id"
                    label="Email *"
                    lazy-rules
                    class="col-3"
                    hide-bottom-space
                  ...
                  <q-input
                    ...
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.description"
                    label="Description"
                    lazy-rules
                    style="width: 250px"
                    label-color="black"
              ...
              <q-form ref="agentFormAddress">
                <div class="q-pa-md row q-gutter-md items-start">
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.building_no"
                    label="House/Flat No *"
                    lazy-rules
                    label-color="black"
                    :rules="[required('House')]"
                  ...
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.street"
                    label="Street/Colony Name*"
                    lazy-rules
                    label-color="black"
                    :rules="[required('Street/Colony')]"
                  ...
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.land_mark"
                    label="Landmark"
                    label-color="black"
                    ><template v-slot:prepend>
                      <q-icon
                  ...
                  <q-select
                    ...
                    options-dense
                    input-debounce="0"
                    v-model="editequipmentPartnerForm.country"
                    label="Country *"
                    label-color="black"
                    :rules="[required('Country')]"
                  >
                  ...
                  <q-select
                    ...
                    option-value="state_id"
                    option-label="state_name"
                    v-model="editequipmentPartnerForm.state"
                    @input="
                      loadAllCities(editequipmentPartnerForm.state);
                      emptyCities();
                    "
                    label="State *"
                    label-color="black"
                  ...
                  <q-select
                    ...
                    options-dense
                    input-debounce="0"
                    v-model="editequipmentPartnerForm.city"
                    label="City *"
                    label-color="black"
                    :rules="[required('City')]"
                    ><template v-slot:prepend>
                  ...
                  <q-input
                    ...
                    lazy-rules
                    mask="######"
                    v-model="editequipmentPartnerForm.pin_code"
                    label="Pincode *"
                    label-color="black"
              ...
              <q-form ref="agentFormStaDocs">
                ...
                <div class="q-pa-md row q-gutter-md items-start">
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.pan"
                    label="PAN No"
                    mask="AAAAA####A"
                    label-color="black"
                    :rules="[required('Pancard'), panNumber()]"
                  ...
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.aadhar"
                    mask="############"
                    label="AADHAAR No"
                    label-color="black"
                  /><q-file
                  ...
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.gstin"
                    label="GSTIN"
                    label-color="black"
                    mask="##AAAAA####A###"
                  />
            ...
            >
              <q-form ref="propertyPartnerFormSubmit">
                <div class="q-pa-md row q-gutter-md items-start">
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.bankAccountNo"
                    label="Bank A/C No"
                    label-color="black"
                    :rules="[required('Bank A/C no'), number()]"
                  />
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.bankName"
                    label="Bank Name"
                    label-color="black"
                    :rules="[required('Bank Name')]"
                  />
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.branchName"
                    label="Branch Name"
                    label-color="black"
                    :rules="[required('Branch')]"
                  />
                  <q-input
                    dense
                    outlined
                    v-model="editequipmentPartnerForm.ifsc"
                    label="IFSC Code"
                    label-color="black"
                    :rules="[required('IFSC code')]"
                  />
                ...
                <q-card-actions align="left">
                  <q-toggle
                    v-model="editequipmentPartnerForm.accept"
              ...
              <q-stepper-navigation class="q-pa-md q-gutter-md">
                ...
                <q-btn
                  ...
                  label="Update"
                  class="text-bold"
                   @click="onequipmentPartnerUpdate"

                  :disable="this.editequipmentPartnerForm.accept == false"
                />
                <q-btn
                  outline
                  @click="step = 3"
            ...
            <q-bar class="bg-primary text-white">
              ...
              flat
               ...
               >
                ...
                @click="this.emptyValue()" >Close</q-tooltip>
              </q-btn>
            </q-bar>
          </q-header>
...
export default {
  data() {
    return {
      ...validations,
      // ...filepaths,
      title: "MH Medical Equipment Partner (MHMEP)",
      step: 1,
      label2: "",
      selected: [],
      data: [],
      ...
      Countries: ["India"],
      pinnumberRules: [
        val => !!val || "Pin Code is required",
        val => /^[0-9_ ]*$/.test(val) || "Only Numbers are allowed",
        val => (val && val.length == 6) || "MAX 6 characters"
      ],
  ...
  computed: {
    ...mapState({
      ...
      equipment_partner_registration_columns: state =>
        state.dashboard.equipment_partner_registration_columns,
      equipment_partner_registration_status_count: state =>
        state.dashboard.equipment_partner_registration_status_count,
      equipment_registration_rows: state =>
        state.dashboard.equipment_registration_rows,
      equipment_registration_columns: state =>
        state.dashboard.equipment_registration_columns,
      equipment_item_rows: state => state.dashboard.equipment_item_rows,
      equipment_item_columns: state => state.dashboard.equipment_item_columns,
    ...
    ...mapGetters("dashboard", ["equipment_partner_registration_status_count"]),
    ...mapGetters("dashboard", ["equipment_partner_registration_rows"])
  },
  mounted() {
    this.$store.dispatch("dropdown/loadAllProperty");
    this.$store.dispatch("dashboard/getEquipmentRegistrationStatusCount");
    this.$store.dispatch("dashboard/getEquipmentRegistrationMaster");
  ...
  methods: {
    ...
    // fileRules: [
    //     v => !!v || "File Upload is required",
    //     v => (v && v.length == 10) || "File Upload is required"
    // ],
    emptycities() {
    ...
    ...mapActions("dashboard", ["equipmentRegistrationMasterAdd"]),
    ...mapActions("dashboard", ["createEquipmentLocation"]),
    ...mapActions("dashboard", ["getEquipmentLocationDetails"]),
    ...mapActions("dashboard", ["getEquipmentRegistrationMaster"]),
    ...mapActions("dashboard", ["getEquipmentRegistrationBasedOnStatus"]),
    ...mapActions("master", ["loadAllCities"]),
    ...mapActions("dashboard", ["updatingEquipmentDetailsForm"]),
    ...mapActions("dashboard", ["updateEquipmentPartnerForm"]),
    ...mapActions("dashboard", ["equipmentRegistrationMasterExistingUser"]),
    ...mapActions("dashboard", ["updateEquipmentDetails"]),
            ...
            if (this.editedItem.equipment_id != "") {
              this.$q
                ...
                .onOk(() => {
                  ...
                  this.step = 1;
                  this.$store.dispatch(
                    "dashboard/getEquipmentRegistrationStatusCount"
                  );
            ...
            .onOk(() => {
             ...
             // this.editpropertyPartnerForm.account_id = this.userDetails.account_id;
              const formData = new FormData();
                  ...
                  formData.append(
                    "updateEquipment",
                    JSON.stringify(this.editequipmentPartnerForm)

                  );
                  // console.log("update", this.editequipmentPartnerForm);

              this.updateEquipmentPartnerForm(formData);
              // this.editequipmentPartnerForm = equipmentRegistrationMaster();
    ...
    editPropertyItem(item) {
      ...
      this.editequipmentPartnerForm.equipment_id = item.equipment_id;
      this.editequipmentPartnerForm.equipment_sub_id = item.equipment_sub_id;
      this.editequipmentPartnerForm.name = item.equipment_sub_name;
      this.editequipmentPartnerForm.agent_name = item.agent_name;
      this.editequipmentPartnerForm.equipment_sub_name = item.equipment_sub_name;
      this.editequipmentPartnerForm.company_name = item.company_name;
      this.editequipmentPartnerForm.individual_name = item.individual_name;
      this.editequipmentPartnerForm.phone = item.phone;
      this.editequipmentPartnerForm.fax = item.fax;
      this.editequipmentPartnerForm.email_id = item.email_id;
      this.editequipmentPartnerForm.agent_commission = item.agent_commission;
      this.editequipmentPartnerForm.description = item.description;
      this.editequipmentPartnerForm.building_no = item.building_no;
      this.editequipmentPartnerForm.street = item.street;
      this.editequipmentPartnerForm.land_mark = item.land_mark;
      this.editequipmentPartnerForm.country = item.country;
      this.editequipmentPartnerForm.state = item.state;
      this.editequipmentPartnerForm.state_id = item.state_id;
      this.editequipmentPartnerForm.city = item.city;
      this.editequipmentPartnerForm.city_id = item.city_id;
      this.editequipmentPartnerForm.pin_code = item.pin_code;
      this.editequipmentPartnerForm.pan = item.pan;
      this.editequipmentPartnerForm.aadhar = item.aadhar;
      this.editequipmentPartnerForm.gstin = item.gstin;
      this.editequipmentPartnerForm.bankAccountNo = item.bankAccountNo;
      this.editequipmentPartnerForm.bankName = item.bankName;
      this.editequipmentPartnerForm.branchName = item.branchName;
      this.editequipmentPartnerForm.ifsc = item.ifsc;
      this.editequipmentPartnerForm.status = item.status;
      //docs update
      this.editequipmentPartnerForm.pan_card_upt = item.pan_card_file_loc;
      this.editequipmentPartnerForm.addhaar_no_upt = item.addhaar_no_loc;
      this.editequipmentPartnerForm.mh_agreement_upt = item.mh_agreement_loc;
      this.editequipmentPartnerForm.mb_certificate_upt = item.mb_certificate_loc;
      this.editequipmentPartnerForm.gst_tin_upt = item.gst_tin_loc;
      this.editequipmentPartnerForm.property_tax_upt = item.property_tax_loc;
      this.editequipmentPartnerForm.fire_safety_upt = item.fire_safety_loc;
      this.editequipmentPartnerForm.cancelled_cheque_upt =
    ...
    openequipmentLocationForm() {
      this.equipmentLocationForm = true;
      this.editMedicalDetails.user_id = this.editedItem.account_id;
      ...
      this.equipmentItemDetails.price = this.editedItem.price;
