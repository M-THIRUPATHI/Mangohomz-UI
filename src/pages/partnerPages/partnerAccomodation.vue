        ...
        <q-card>
          ...
          >
                  ...
                  <div class="row col-12 justify-center">
                    <div class="row col-3 q-mt-sm">
                      <span class="text-bold"
                        >1. Property Owner/Lease/Manager Name *
                      </span>
                      <q-input
                    ...
                    <div class="row col-6 justify-center">
                      <q-checkbox
                        ...
                        class="text-bold"
                        v-model="yes"
                        label="2. Is The Business/Company Entity Name is same as property partner name?"
                      />
                      <div class="row col-6 q-ml-sm">
                        <q-input
                          ...
                          label="Business/Company Entity Name"
                          hide-bottom-space
                          style="width: 250px"
                          label-color="black"
                          v-if="yes == true"
                  ...
                  <div class="row col-12 q-mt-lg justify-center">
                    ...
                    <div class="row col-6 justify-center">
                      <q-checkbox
                        ...
                        class="text-bold"
                        v-model="no"
                        label="4. Is Your Whatsapp Number is same as Phone Number ?"
                      />
                      <div class="row col-6 q-ml-sm">
                        <q-input
                          dense
            ...
            <q-step :name="3" :done="step > 3" title="eKYC" icon="assignment">
              <q-form ref="agentFormStaDocs">
                ...
                <div class="q-pa-md row q-gutter-md items-start">
                  ...
                  <q-input
                    ...
                    v-bind:readonly="this.onclickValue == 'edit'"
                    v-if="
                      this.propertyPartnerForm.gst_registration == 'Registered'
                    "
                  />
                  ...
                  <q-file
                    ...
                    @rejected="onRejected"
                    v-if="
                      this.propertyPartnerForm.gst_registration !=
                      'un Registered'
                    "
                  >
                    <template v-slot:prepend>
              ...
              <q-stepper-navigation
                class="q-pa-md q-gutter-md text-center justify-center"
              >
                <q-btn
                  @click="
                    () => {
              ...
              <q-form ref="agentFormBankDetails">
                <q-bar>
                  <div class="text-bold text-black">
                    Owner/Lease/Manager/Company Account Details *
                  </div>
                </q-bar>
                    ...
                    <q-card-section class="q-pa-none">
                      <div style="height: 300px">
                        ...
                        >
                          <div class="col-5 text-left">Account No</div>
                          <div class="col-7 text-left text-grey">
                            : {{ propertyEditedItem.bankAccountNo }}
                          </div>
                          <q-separator />
                          <div class="col-5 text-left">Bank Name</div>
                          <div class="col-7 text-left text-grey">
                            : {{ propertyEditedItem.bankName }}
                          </div>
                          <q-separator />
                          <div class="col-5 text-left">Branch</div>
                          <div class="col-7 text-left text-grey">
                            : {{ propertyEditedItem.branchName }}
                          </div>
                          <q-separator />
                          <div class="col-5 text-left">IFSC Code</div>
                          <div class="col-7 text-left text-grey">
                            : {{ propertyEditedItem.ifsc }}
                          </div>

                          <div class="col-5 text-left">MH Sharing In %</div>
                          <div class="col-7 text-left text-grey">
                  ...
                  <q-markup-table class="q-ma-xs">
                    ...
                    <tbody>
                      <div class="row">
                        ...
                        <div class="col-3">
                          <tr>
                            <td class="text-left text-bold">Property Image2</td>
                            <td>
                              <q-btn
                                class="text-bold"
                                label="view"
                        ...
                        <div class="col-3">
                          <tr>
                            <td class="text-left text-bold">Property Image3</td>
                            <td>
                              <q-btn
                                class="text-bold"
                                label="view"
                        ...
                        <div class="col-3">
                          <tr>
                            <td class="text-left text-bold">Property Image4</td>
                            <td>
                              <q-btn
                                class="text-bold"
                                label="view"
                                ...
                                @click="
                                  showDocument(
                                    propertyEditedItem.upload_image3,
                                    'Property Image4'
                                  )
                                "
                              />
                      ...
                      <div class="row">
                        <div class="col-3">
                          <tr>
                            <td class="text-left text-bold">Property Image5</td>
                            <td class="text-center">
                              <q-btn
                                class="text-bold"
                                label="view"
                                ...
                                @click="
                                  showDocument(
                                    propertyEditedItem.upload_image4,
                                    'Property Image4'
                                  )
                                "
                              />
                        ...
                        <div class="col-3">
                          <tr>
                            <td class="text-left text-bold">MH Agreement</td>
                        ...
                        <div class="col-3">
                          <tr>
                            <td class="text-left text-bold">Declaration</td>
                        ...
                        <div class="col-3">
                          <tr>
                            <td class="text-left text-bold">Bank Mandate</td>
                            <td class="text-center">
                              <q-btn
                                class="text-bold"
                                label="view"
                ...
                <q-card>
                    ...
                    <q-card-actions>
                      <div class="row items-start q-gutter-md">
                        ...
                        <q-select
                          ...
                          option-value="state_id"
                          option-label="state_name"
                          v-model="editedPropertyData.state"
                          @input="
                            loadAllCities(editedPropertyData.state);
                            emptyCities();
                          "
                          label="State *"
                          hide-bottom-space
                        ...
                        <q-select
                          ...
                          options-dense
                          input-debounce="0"
                          v-model="editedPropertyData.city"
                          label="City *"
                          label-color="black"
                          hide-bottom-space
                          :rules="[required('City')]"
                  ...
                  <q-card flat class="q-pa-md">
                    ...
                    <q-card-actions>
                      ...
                      <!-- Bank Details Edit  Start-->

                      <q-separator />
                      <!-- <q-card flat class="q-pa-md">
                        <q-bar>
                          <div class="text-bold text-black">
                            Bank Details Of Property
                          </div>
                        </q-bar>
                        <q-card-actions>
                          <div class="row items-start q-gutter-md">
                      ...
                      <div class="row items-start q-gutter-md">
                        <q-file
                          ...
                          :rules="[
                            (val) =>
                              (val != '' && uploadImage != '') ||
                              'Please Upload Property Front Image 1',
                          ]"
                          :filter="checkFileSize"
                          @rejected="onRejected"
                        >
                        ...
                        <q-btn
                          ...
                          @click="
                            showDocument(
                             editedPropertyData.upload_image,
                              'Property Image1'
                            )
                          "
                        >
                          <q-tooltip :disable="$q.platform.is.mobile"
                            >Property Front Image 1</q-tooltip
                          >
                        </q-btn>
                        <q-file
                          color="lime-11"
                          ...
                          :rules="[
                            (val) =>
                              (val != '' && uploadImage1 != '') ||
                              'Please Upload Property Front Image 2',
                          ]"
                          :filter="checkFileSize"
                          @rejected="onRejected"
                        >
                        ...
                        <q-btn
                          ...
                          @click="
                            showDocument(
                              editedPropertyData.upload_image1,
                              'Property Image2'
                            )
                          "
                        >
                          <q-tooltip :disable="$q.platform.is.mobile"
                            >Property Front Image 2</q-tooltip
                          >
                        </q-btn>
                        <q-file
                          color="lime-11"
                          ...
                          :rules="[
                            (val) =>
                              (val != '' && uploadImage2 != '') ||
                              'Please Upload Property Reception',
                          ]"
                          :filter="checkFileSize"
                          @rejected="onRejected"
                        >
                        ...
                        <q-btn
                          ...
                          @click="
                            showDocument(
                              editedPropertyData.upload_image2,
                              'Property Image3'
                            )
                          "
                        >
                          <q-tooltip :disable="$q.platform.is.mobile"
                            >Property Reception</q-tooltip
                          >
                        </q-btn>
                        <q-file
                          color="lime-11"
                        ...
                        <q-btn
                          ...
                          @click="
                            showDocument(
                              editedPropertyData.upload_image3,
                              'Property Image4'
                            )
                          "
                        >
                          <q-tooltip :disable="$q.platform.is.mobile"
                            >Property Lobby</q-tooltip
                          >
                        </q-btn>
                        <q-file
                          color="lime-11"
                          ...
                          :rules="[
                            (val) =>
                              (val != '' && uploadImage4 != '') ||
                              'Please Upload Property Side Image',
                          ]"
                          :filter="checkFileSize"
                          @rejected="onRejected"
                        >
                        ...
                        <q-btn
                          ...
                          @click="
                            showDocument(
                                   editedPropertyData.upload_image4,
                              'Property Image5'
                            )
                          "
                        >
                          <q-tooltip :disable="$q.platform.is.mobile"
                            >Property Side Image</q-tooltip
                          >
                        </q-btn>
                      </div>
                ...
                <q-card flat class="q-pa-md" padding style="padding-top: 45px">
                  ...
                  <q-card-actions>
                    <div class="row items-start q-gutter-md">
                      ...
                      <!-- <q-select
                        ref="myChipEditInput"
                        v-model="editedRoomsData.room_numbers"
                        multiple
                        dense
                        outlined
                        use-chips
                  ...
                  <q-card-actions>
                    <div class="row items-start q-gutter-md">
                      <q-select
                        ...
                        v-model="editedRoomsData.select_offer"
                        label="Select Offer*"
                        label-color="black"
                      ...
                      <q-input
                        dense
                        outlined
                        v-model="editedRoomsData.enter_amount"
                        label="Enter Amount *"
                        ...
                        label-color="black"
                        hide-bottom-space
                        v-if="this.editedRoomsData.select_offer == 'Amount'"
                      >
                        <template v-slot:prepend>
                      ...
                      <q-input
                        ...
                        label-color="black"
                        hide-bottom-space
                        v-if="this.editedRoomsData.select_offer == 'Percentage'"
                      >
                        <template v-slot:prepend>
                          <q-icon
                  ...
                  <q-card-actions>
                    <div class="row items-start q-gutter-md">
                      ...
                      <q-btn
                        ...
                        @click="
                          showDocument(
                            editedRoomsData.room_image_1,
                            'Room Image1'
                          )
                        "
                      >
                        <q-tooltip :disable="$q.platform.is.mobile"
                          >View Room Image1</q-tooltip
                        >
                      </q-btn>
                      <q-file
                        color="lime-11"
                      ...
                      <q-btn
                        ...
                        @click="
                          showDocument(
                            editedRoomsData.room_image_2,
                            'Room Image2'
                          )
                        "
                      >
                        <q-tooltip :disable="$q.platform.is.mobile"
                          >View Room Image2</q-tooltip
                        >
                      </q-btn>
                      <q-file
                        color="lime-11"
                      ...
                      <q-btn
                        ...
                        @click="
                          showDocument(
                            editedRoomsData.room_image_3,
                            'Washroom Image1'
                          )
                        "
                      >
                        <q-tooltip :disable="$q.platform.is.mobile"
                          >View Washroom Image1</q-tooltip
                        >
                      </q-btn>
                      <q-file
                        color="lime-11"
                      ...
                      <q-btn
                        ...
                        @click="
                          showDocument(
                            editedRoomsData.room_image_4,
                            'Washroom Image2'
                          )
                        "
                      >
                        <q-tooltip :disable="$q.platform.is.mobile"
                          >View Washroom Image2</q-tooltip
                        >
                      </q-btn>
                      <q-file
                        color="lime-11"
                      ...
                      <q-btn
                        ...
                        @click="
                          showDocument(
                            editedRoomsData.room_image_5,
                            'Additional Image'
                          )
                        "
                      >
                        <q-tooltip :disable="$q.platform.is.mobile"
                          >View Additional Image</q-tooltip
                        >
                      </q-btn>
                    </div>
                  </q-card-actions>
            ...
            >
              <q-layout view="Lhh lpR fff" container class="bg-white">
                <q-form
                  ...
                  clearable
                  dense
                  ref="accMedicalDialog"
                  class="q-gutter-xs"
                  lazy-rules
                  hide-bottom-space
                  :rules="[
                    (val) => (val && val.length > 0) || 'Please enter Values',
                  ]"
                >
                  <q-card>
                    <q-bar class="bg-primary">
                    ...
                    <template v-slot:prepend>
                      <q-icon name="mdi-account" color="secondary" />
                          ...
                          <q-input
                            ...
                            options-dense
                            outlined
                            v-model="editAccMedical.medical_store"
                            label="Medical Store *"
                            use-input
                            hide-selected
                            style="width: 250px"
                          ...
                          <q-select
                            ...
                            options-dense
                            outlined
                            v-model="editAccMedical.item_name"
                          ...
                          <q-select
                            v-model="editAccMedical.purchased_type"
                            dense
                            options-dense
                            outlined
                            use-input
          ...
          <q-form ref="AccTravelPartnerDialog">
            ...
            <div class="row q-pa-md justify-end">
              <q-btn
                ...
                label="Submit"
                v-if="this.onclickValue != 'edit'"
                @click="submitTravel('submit')"
                :disable="this.otherAcctravelPartner.accept == false"
              />
              <q-btn
                color="secondary"
                label="Update"
                class="text-bold"
                @click="submitTravel('update')"
                v-if="this.onclickValue == 'edit'"
                :disable="this.otherAcctravelPartner.accept == false"
              />
            </div>
          ...
          <q-form ref="AccFoodPartnerDialog">
            ...
            <div class="row q-pa-md justify-end">
              <q-btn
                ...
                :disable="this.AccFoodPartner.accept == false"
              />
              <q-btn
                color="secondary"
                label="Update"
        ...
        <q-layout view="Lhh lpR fff" container class="bg-white">
          <q-form ref="propertyFormBasic" class="q-gutter-xs">
            <q-card>
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    ...
                    <!-- <q-input
                      ...
                      lazy-rules
                      style="width: 290px"
                      v-model="propertyDetails.mh_service_fee"
                      label="MH Service Commission In %*"
                      label-color="black"
                      hide-bottom-space
                      :rules="[required('MH Service Commission In %'), number()]"
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="propertyDetails.property_alternate_email"
                      label="Alternate Email"
                      lazy-rules
                      hide-bottom-space
                      style="width: 250px"
              ...
              <!--Add Bank Details Add New Start-->
                ...
                <q-card-actions>
                  <div class="q-pa-md row q-gutter-md items-start">
                    <q-input
                      dense
                      outlined
                      v-model="propertyDetails.bankAccountNo"
                      label="Bank A/C No"
                      label-color="black"
                      :rules="[required('Bank A/C no'), number()]"
                    />
                    <q-input
                      dense
                      outlined
                      v-model="propertyDetails.bankName"
                      label="Bank Name"
                      label-color="black"
                      :rules="[required('Bank Name')]"
                    />
                    <q-input
                      dense
                      outlined
                      v-model="propertyDetails.branchName"
                      label="Branch Name"
                      label-color="black"
                      :rules="[required('Branch')]"
                    />
              ...
              <q-card flat class="q-pa-md">
                ...
                <q-card-actions>
                  <div class="q-pa-md row q-gutter-md items-start">
                    ...
                    fill-input
                    :options="gstOptions"
                    v-model="propertyDetails.gst_registration"
                    label="GST Registration*"
                    label-color="black"
                    v-bind:readonly="this.onclickValue == 'edit'"
                    :rules="[required('Property Type')]"
                  ...
                  <q-input
                    ...
                    v-bind:readonly="this.onclickValue == 'edit'"
                    v-if="
                      this.propertyDetails.gst_registration == 'Registered'
                    "
                  />
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    <q-select
                      ...
                      fill-input
                      :options="offerOptions"
                      v-model="roomDetails.select_offer"
                      label="Select Offer*"
                      label-color="black"
                    >
                      <template v-slot:no-option>
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="roomDetails.enter_amount"
                      label="Enter Amount *"
                      lazy-rules
                      style="width: 180px"
                      label-color="black"
                      hide-bottom-space
                      v-if="this.roomDetails.select_offer == 'Amount'"
                    >
                      <template v-slot:prepend>
                        <q-icon name="mdi-currency-inr" color="secondary" />
                      </template>
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="roomDetails.special_offer"
                      label="Special Offer *"
                      :rules="[specialMOfferValue('Special Offer', 100)]"
                      lazy-rules
                      mask="###"
                      style="width: 250px"
                      label-color="black"
                      hide-bottom-space
                      v-if="this.roomDetails.select_offer == 'Percentage'"
                    >
                      <template v-slot:prepend>
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    <q-file
                      ...
                      :rules="[
                        (val) =>
                          (val != '' && uploadRoomImage1 != '') ||
                          'Please Upload Room Image1',
                      ]"
                      :filter="checkFileSize"
                      @rejected="onRejected"
                    >
                    ...
                    <q-file
                      ...
                      :rules="[
                        (val) =>
                          (val != '' && uploadRoomImage2 != '') ||
                          'Please Upload Room Image2',
                      ]"
                      :filter="checkFileSize"
                      @rejected="onRejected"
                    >
                    ...
                    <q-file
                      ...
                      :rules="[
                        (val) =>
                          (val != '' && uploadRoomImage3 != '') ||
                          'Please Upload Washroom Image1',
                      ]"
                      :filter="checkFileSize"
                      @rejected="onRejected"
                    >
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    <q-select
                      ...
                      fill-input
                      :options="offerOptions"
                      v-model="restaurantDetails.select_offer"
                      label="Select Offer*"
                      label-color="black"
                      :rules="[required('Property Type')]"
                    >
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="restaurantDetails.enter_amount"
                      label="Enter Amount *"
                      ...
                      label-color="black"
                      hide-bottom-space
                      v-if="this.restaurantDetails.select_offer == 'Amount'"
                    >
                      <template v-slot:prepend>
                        <q-icon name="mdi-currency-inr" color="secondary" />
                      </template>
                    ...
                    <q-input
                      ...
                      label-color="black"
                      hide-bottom-space
                      v-if="this.restaurantDetails.select_offer == 'Percentage'"
                    >
                      <template v-slot:prepend>
                        <q-icon name="mdi-percent-outline" color="secondary" />
                      </template>
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    <q-input
                      ...
                      label="Opening Time *"
                      dense
                      v-model="restaurantDetails.opening_time"
                      :rules="[required('Check In Time')]"
                      @click="$refs.qOpeningTime.show()"
                    >
                      <template v-slot:append>
                    ...
                    <q-input
                      ...
                      label="Closing Time *"
                      dense
                      v-model="restaurantDetails.closing_time"
                      :rules="[required('Check Out Time')]"
                      @click="$refs.qClosingTime.show()"
                    >
                      <template v-slot:append>
                  ...
                  <div class="row items-start q-gutter-md">
                    <q-file
                      ...
                      :rules="[
                        (val) =>
                          (val != '' && upload_Image != '') ||
                          'Please Upload Restaurant Front Image 1',
                      ]"
                      :filter="checkFileSize"
                      @rejected="onRejected"
                    >
                ...
                <q-card-section class="q-pa-none">
                  <div style="height: 300px">
                    ...
                    >
                      ...
                      <q-separator />showRestaurantDocument
                      <div class="col-5 text-left">State</div>
                      <div class="col-7 text-left text-grey">
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    <q-select
                      ...
                      fill-input
                      :options="offerOptions"
                      v-model="editRestaurantDetails.select_offer"
                      label="Select Offer*"
                      label-color="black"
                      :rules="[required('Property Type')]"
                    >
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="editRestaurantDetails.enter_amount"
                      label="Enter Amount *"
                      :rules="[required('Enter Amount')]"
                      lazy-rules
                      style="width: 180px"
                      label-color="black"
                      hide-bottom-space
                      v-if="this.editRestaurantDetails.select_offer == 'Amount'"
                    >
                      <template v-slot:prepend>
                        <q-icon name="mdi-currency-inr" color="secondary" />
                      </template>
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    ...
                    <q-select
                      ...
                      option-value="state_id"
                      option-label="state_name"
                      v-model="editRestaurantDetails.state"
                      @input="
                    ...
                    <q-select
                      ...
                      options-dense
                      input-debounce="0"
                      v-model="editRestaurantDetails.city"
                      label="City *"
                      label-color="black"
                      hide-bottom-space
                      :rules="[required('City')]"
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    <q-input
                      ...
                      label="Opening Time *"
                      dense
                      v-model="editRestaurantDetails.opening_time"
                      :rules="[required('Check In Time')]"
                    >
                      <template v-slot:append>
                        <q-icon name="access_time" class="cursor-pointer">
                    ...
                    <q-input
                      ...
                      label="Closing Time *"
                      dense
                      v-model="editRestaurantDetails.closing_time"
                      :rules="[required('Check Out Time')]"
                    >
                      <template v-slot:append>
                        <q-icon name="access_time" class="cursor-pointer">
                  ...
                  <div class="row items-start q-gutter-md">
                    <q-file
                      ...
                      :rules="[
                        (val) =>
                          (val != '' && upload_Image != '') ||
                          'Please Restaurant Front Image 1',
                      ]"
                      :filter="checkFileSize"
                      @rejected="onRejected"
                    >
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    ...
                    <q-file
                      ...
                      "
                      hint="Upload Image of licence plate "
                      :rules="[(val) => val || 'Please select file']"
                      :filter="checkFileSize"
                      @rejected="onRejected"
                    >
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    <q-select
                      ...
                      fill-input
                      :options="offerOptions"
                      v-model="AccMedicalStore.select_offer"
                      label="Select Offer*"
                      label-color="black"
                      :rules="[required('Property Type')]"
                    >
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="AccMedicalStore.enter_amount"
                      label="Enter Amount *"
                      :rules="[required('Enter Amount')]"
                      lazy-rules
                      style="width: 180px"
                      label-color="black"
                      hide-bottom-space
                      v-if="this.AccMedicalStore.select_offer == 'Amount'"
                    >
                      <template v-slot:prepend>
                        <q-icon name="mdi-currency-inr" color="secondary" />
                      </template>
                    ...
                    <q-input
                      ...
                      label-color="black"
                      hide-bottom-space
                      v-if="this.AccMedicalStore.select_offer == 'Percentage'"
                    >
                      <template v-slot:prepend>
                        <q-icon name="mdi-percent-outline" color="secondary" />
                      </template>
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="AccMedicalStore.from_date"
                      label="Date From"
                      label-color="black"
                      clear-icon="close"
                      minimal
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="AccMedicalStore.to_date"
                      label="Date To"
                      label-color="black"
                      clear-icon="close"
                      minimal
            ...
            >
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <q-card flat bordered class="bg-white">
                  ...
                  <div class="q-pa-md" style="padding-top: 10px">
                    <q-table
                      :data="equipment_acc_rows"
                      :columns="equipment_acc_columns"
                      :pagination.sync="pagination"
                      dense
                      row-key="sno"
                      :filter="filter"
                      ...
                      <template v-slot:body-cell-actions1="props">
                        <q-td :props="props">
                          <q-btn
                            ...
                            icon="mdi-pencil"
                            size="sm"
                            @click="editAccEquipment(props.row)"
                          >
                            <q-tooltip :disable="$q.platform.is.mobile"
                              >Edit</q-tooltip
                            >
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    ...
                    <!-- <q-select dense options-dense outlined use-input hide-selected style="width: 200px" fill-input
                      :options="offerOptions" v-model="medicalstoreeditedItem.select_offer" label="Select Offer*"
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    <q-select
                      ...
                      fill-input
                      :options="offerOptions"
                      v-model="medicalstoreeditedItem.select_offer"
                      label="Select Offer*"
                      label-color="black"
                      :rules="[required('Property Type')]"
                    >
                    ...
                    <q-input
                      dense
                      outlined
                      v-model="medicalstoreeditedItem.enter_amount"
                      label="Enter Amount *"
                      :rules="[required('Enter Amount')]"
                      lazy-rules
                      style="width: 180px"
                      ...
                      hide-bottom-space
                      v-if="
                        this.medicalstoreeditedItem.select_offer == 'Amount'
                      "
                    >
                      <template v-slot:prepend>
                        <q-icon name="mdi-currency-inr" color="secondary" />
                    ...
                    <q-input
                      ...
                      hide-bottom-space
                      v-if="
                        this.medicalstoreeditedItem.select_offer == 'Percentage'
                      "
                    >
                      <template v-slot:prepend>
                        <q-icon name="mdi-percent-outline" color="secondary" />
                ...
                <q-card-actions>
                  <div class="row items-start q-gutter-md">
                    ...
                    <q-select
                      ...
                      option-value="state_id"
                      option-label="state_name"
                      v-model="medicalstoreeditedItem.state"
                      @input="
                    ...
                    <q-select
                      ...
                      options-dense
                      input-debounce="0"
                      v-model="medicalstoreeditedItem.city"
                      label="City *"
                      label-color="black"
                      hide-bottom-space
                      :rules="[required('City')]"
                  ...
                  <div class="row items-start q-gutter-md">
                    <q-file
                      ...
                      :rules="[
                        (val) =>
                          (val != '' &&
                            medicalstoreeditedItem.uploadImage1 != '') ||
                          'Please Upload Store Image 1',
                      ]"
                      :filter="checkFileSize"
                      @rejected="onRejected"
...
export default {
  data() {
    return {
      ...
      selectedCountry: { name: null, id: null },
      propertyDetails: {
        account_id: "",
        property_name: "",
        sub_property_name: "",
...
gst_registration:"",
      ...
      roomTypeArr: ["Single Share", "Double Share", "Triple Share","Quadruple Share","Family Room 5 Share"],
      room_categoryArr: ["Executive", "Deluxe", "Studio", "Super Deluxe","Standard","Superior","Premium","Economy King Bed Room","Deluxe King Bed Room","Economy 2 Twin Bed Room","Luxury 2 Twin Bed Room","Family Room","Suite Studio"],
  ...
  computed: {
    ...mapState({
      ...
      acc_food_Details_columns: (state) =>
        state.partners.acc_food_Details_columns,
      ...
      restaurant_data_columns: (state) =>
        state.partners.restaurant_data_columns,
      ...
      acctransport_item_columns: (state) =>
        state.partners.acctransport_item_columns,
      accmedicalstore_item_rows: (state) =>
        state.partners.accmedicalstore_item_rows,
      accmedicalstore_item_columns: (state) =>
        state.partners.accmedicalstore_item_columns,
      medicalAccStoreItems: (state) => state.dropdown.equipment_medical_store,
      property_partner_registration_rows: (state) =>
        state.partners.property_partner_registration_rows,
    }),
  ...
  mounted() {
    ...
    this.$store.dispatch("partners/getPropertyDetails");
    this.$store.dispatch("dropdown/loadAllMedicalStores");
  ...
  methods: {
        ...
        if (success) {
          if (this.propertyDetails.partner_id != "") {
            this.$q
              ...
              .onOk(() => {
                // console.log("uuuuu", this.propertyDetails);
                const formData = new FormData();
                ...
                formData.append("cancelled_cheque", this.cancelled_cheque);
                formData.append("mh_agreement", this.mh_agreement);
                formData.append("mh_declaration", this.mh_declaration);
                formData.append("mh_bankmandate", this.mh_bankmandate);
                formData.append("gst_tin", this.gst_tin);
        ...
        if (success) {
          this.$q
            ...
            .onOk(() => {
              ...
              formData.append("upload_image4", this.uploadImage3);
              formData.append("upload_image5", this.uploadImage4);
              //console.log("123654",this.uploadImage,this.uploadImage1,this.uploadImage2,this.uploadImage3,this.uploadImage4)
              formData.append(
        ...
        if (success) {
          if (this.roomDetails.partner_id != "") {
            this.$q
              ...
              .onOk(() => {
              // console.log("submit", this.roomDetails);
          ...
          this.$q
            ...
            .onOk(() => {
              ...
              this.editedRoomsData.date_to = this.editedRoomsData.date_to
                ...
                // .reverse()
                // .join("-");
              console.log("this.editedRoomsData", this.editedRoomsData);
          ...
          if (this.otherAcctravelPartner.agent_id != "") {
            if (success) {
              this.$q
                ...
                .onOk(() => {
                  // console.log("submittravel", this.otherAcctravelPartner);
                  const formData = new FormData();
                  this.otherAcctravelPartner.user_id =
                    this.userDetails.account_id;
                ...
                .onCancel(() => {
                  ...
                  // console.log("acctravel", this.AccTravelPartnerDialog);
                });
            }
          }
        });
        ...
        if (this.editAccMedical.equipment_id != "") {
          if (success) {
            this.$q
              ...
              .onOk(() => {
                // console.log("updatemedical", this.editAccMedical);
      ...
      this.$refs.editRestaurantForm.validate().then((success) => {
        if (success) {
          this.$q
            ...
            .onOk(() => {
             // console.log("ffff", this.editRestaurantDetails);
          ...
          if (success) {
            if (this.AccFoodPartner.agent_id != "") {
              this.$q
                ...
                .onOk(() => {
                  console.log("food", this.AccFoodPartner);
                  ...
                  console.log("gggg", this.AccFoodPartner);
                  this.AccFoodSaving(formData);
                  this.resetFiles();
                  this.emptyValue();
        ...
        if (success) {
          if (this.restaurantDetails.agent_id != "") {
            this.$q
              ...
              .onOk(() => {
                console.log("save", this.restaurantDetails);
                console.log("save gfdfc", this.upload_fssai);
                const formData = new FormData();
                ...
                formData.append(
                  "restaurant_details",
                  JSON.stringify(this.restaurantDetails)
                );
        ...
        if (this.AccMedicalPartner.agent_id != "") {
          if (success) {
            this.$q
              ...
              .onOk(() => {
                console.log("medical", this.AccMedicalPartner);
    ...
    doOtherStuff() {
      ...
      this.$refs.myChipEditInput.edit(this.inputValue);
    ...
    editPropertyItem(item) {
      ...
      this.propertyPartnerForm.partner_id = this.editedItem.partner_id;
      this.propertyPartnerForm.partner_sub_id = this.editedItem.partner_sub_id;
      this.propertyPartnerForm.name = this.editedItem.agent_name;
      this.propertyPartnerForm.partner_sub_name =
        this.editedItem.agent_sub_name;
      this.propertyPartnerForm.phone = this.editedItem.phone;
      this.propertyPartnerForm.fax = this.editedItem.fax;
      this.propertyPartnerForm.alternate_no = this.editedItem.alternate_no;
      this.propertyPartnerForm.email_id = this.editedItem.email_id;
      this.propertyPartnerForm.description = this.editedItem.description;
      this.propertyPartnerForm.building_no = this.editedItem.building_no;
      this.propertyPartnerForm.street = this.editedItem.street;
      this.propertyPartnerForm.land_mark = this.editedItem.land_mark;
      this.propertyPartnerForm.country = this.editedItem.country;
      this.propertyPartnerForm.state = this.editedItem.state;
      this.propertyPartnerForm.city = this.editedItem.city;
      this.propertyPartnerForm.prevstate = this.editedItem.state;
      this.propertyPartnerForm.prevcity = this.editedItem.city;
      this.propertyPartnerForm.pin_code = this.editedItem.pin_code;
      this.propertyPartnerForm.propertyType = this.editedItem.property_type;
      this.propertyPartnerForm.aadhar = this.editedItem.aadhar;
      this.propertyPartnerForm.gst_registration = this.editedItem.gstin;

      this.propertyPartnerForm.pan = this.editedItem.pan;
      this.pan_card_file = {
        name: item.pan_loc ?? "",
      };
      this.addhaar_no = {
    ...
    editAccTravel(item) {
      ...
      this.otherAcctravelPartner.agent_name = this.editedItem.travel_name;
    ...
    editAccEquipment(item) {
      ...
      console.log("image", this.equipment_image);
    },
    ...
    editPropertyData(item) {
      ...
      this.editedPropertyData.Name_Of_Contact_Person =
      ...
      this.editedPropertyData.state = item.state_name;
      this.editedPropertyData.city = item.city_name;
    ...
    editRoomsData(item) {
      console.log("jhyegb", item);
      this.editedIndex = this.data.indexOf(item);
      this.editedRoomsData = Object.assign({}, item);
      console.log("rooms", this.editedRoomsData);
      this.roomsEditDialog = true;
      const amenity = [
        {
      ...
      // this.editedRoomsData.room_numbers = roomNumbers;
      ...
      this.editedRoomsData.select_offer = item.select_offer;
      this.editedRoomsData.enter_amount = item.enter_amount;
    ...
    openRoomsDialog() {
      ...
      this.roomDetails.partner_name = this.propertyEditedItem.partner_name;
      this.roomDetails.property_specialOffer =
        this.propertyEditedItem.property_specialOffer;
      this.roomDetails.partner_sub_id = this.propertyEditedItem.partner_sub_id;
      this.roomDetails.partner_name = this.propertyEditedItem.partner_name;
      this.roomDetails.units = this.propertyEditedItem.units;
      this.roomDetails.special_offer = this.propertyEditedItem.special_offer;
    ...
    editFoodItem(item) {
      ...
      this.AccFoodPartner.location = item.location;
      this.AccFoodPartner.food_items_name = item.foodName;
      // this.AccFoodPartner.food_type_id = item.food_type_id;
      this.AccFoodPartner.foodItemsList = item.foodName;
    ...
    otherAccFoodForm() {
      ...
      this.AccFoodPartner.sub_Name = this.editedItem.agent_sub_name;
      this.AccFoodPartner.kitchen_name =
        this.restaurantEditedItem.name_of_kitchen;
      this.AccFoodPartner.kitchen_type =
        this.restaurantEditedItem.type_of_kitchen;
      this.AccFoodPartner.address = this.restaurantEditedItem.address;
      this.AccFoodPartner.gstin = this.restaurantEditedItem.gstin;
      this.AccFoodPartner.city = this.restaurantEditedItem.city_name;
      ...
      this.AccFoodPartner.txn_id = this.restaurantEditedItem.txn_id;
      this.AccFoodPartner.items_available_from =
        this.editedItem.items_available_from;
      this.AccFoodPartner.items_available_to =
        this.editedItem.items_available_to;
      this.AccFoodPartner.fssai_no = this.restaurantEditedItem.fssai_no;
      this.AccFoodPartner.select_offer = this.restaurantEditedItem.select_offer;
      this.AccFoodPartner.special_offer =
        this.restaurantEditedItem.special_offer;
      this.AccFoodPartner.enter_amount = this.restaurantEditedItem.enter_amount;
      this.AccFoodPartner.item_txn_id = this.editedItem.item_txn_id;
      this.AccFoodPartner.food_items_id = this.editedItem.food_items_id;
      this.AccFoodPartner.foodPartner_name =
        this.restaurantEditedItem.food_partner_name;
      this.AccFoodPartner.foodPartner_sub_name =
        this.restaurantEditedItem.food_partner_sub_name;
      this.AccFoodPartner.name = this.editedItem.name;
      this.AccFoodPartner.partner_name = this.editedItem.partner_name;
      this.AccFoodPartner.partner_sub_name = this.editedItem.partner_sub_name;
      this.AccFoodPartner.foodData = this.editedItem.foodData;

      // this.AccFoodPartner.units=this.editedItem.units;
      this.AccFoodPartner.price = this.editedItem.price;

      this.onclickValue = "";
      this.emptyValue();
      this.AccFoodPartnerDialog = true;
      console.log("food", this.AccFoodPartner);
      console.log("accfood", this.restaurantEditedItem);
    },
    otherAccTravelForm() {
      console.log("trave1l", this.editedItem, this.otherAcctravelPartner);
      this.otherAcctravelPartner.account_id = this.userDetails.account_id;
      this.otherAcctravelPartner.account_id = this.userDetails.account_id;
      this.otherAcctravelPartner.agent_id = this.editedItem.agent_id;
      this.otherAcctravelPartner.transport_sub_id =
        this.editedItem.transport_sub_id;
      this.otherAcctravelPartner.agent_name = this.editedItem.agent_name;
      this.otherAcctravelPartner.no_of_seaters = this.editedItem.no_of_seaters;
      this.otherAcctravelPartner.transport_sub_name =
        this.editedItem.transport_sub_name;
      ...
      this.otherAcctravelPartner.vehicle_type = this.editedItem.vehicle_type;
      this.otherAcctravelPartner.vehicle_name = this.editedItem.vehicle_name;
      this.otherAcctravelPartner.day_price = this.editedItem.day_price;
      this.otherAcctravelPartner.night_price = this.editedItem.night_price;
      this.otherAcctravelPartner.units = this.editedItem.units;
      this.otherAcctravelPartner.description = this.editedItem.description;
      this.otherAcctravelPartner.special_offer = this.editedItem.special_offer;
      this.otherAcctravelPartner.travel_status = this.editedItem.status;
      this.otherAcctravelPartner.status = this.editedItem.status;
    ...
    accMedicalstoreDetailsForm() {
      ...
      this.AccMedicalStore.city = this.editedItem.city;
      ...
      this.AccMedicalStore.equipment_sub_name =
        this.editedItem.partner_sub_name;
      this.AccMedicalStore.email_id = this.editedItem.email_id;
      this.AccMedicalStore.partner_status = this.editedItem.status;
      this.AccMedicalStore.date_from = this.editedItem.date_from;
      this.AccMedicalStore.date_to = this.editedItem.date_to;
    ...
    opentransportDialog() {
      ...
      this.transportDetails.transport_sub_name =
        this.editedItem.partner_sub_name;
      this.transportDetails.from_date = this.editedItem.from_date;
      this.transportDetails.to_date = this.editedItem.to_date;
      this.onclickValue = "";
        ...
        if (success) {
          if (this.transportDetails.partner_id != "") {
            this.$q
              ...
              .onOk(() => {
                console.log("transport", this.transportDetails);
                const formData = new FormData();
        ...
        if (this.transporteditedItem.agent_id != "") {
          if (success) {
            this.$q
              ...
              .onOk(() => {
                console.log("updatetransport", this.transporteditedItem);
        ...
        if (success) {
          if (this.AccMedicalStore.agent_id != "") {
            this.$q
              ...
              .onOk(() => {
                console.log("savemedical", this.AccMedicalStore);
    ...
    editMedicalStoreDetails(item) {
      ...
      this.medicalstoreeditedItem.medical_store_name = item.medical_store_name;
      this.medicalstoreeditedItem.special_offer = item.special_offer;
      this.medicalstoreeditedItem.date_from = item.from_date;
      this.medicalstoreeditedItem.date_to = item.to_date;
      ...
      this.medicalstoreeditedItem.city = item.city_name;
      this.medicalstoreeditedItem.state = item.state_name;
        ...
        if (this.medicalstoreeditedItem.agent_id != "") {
          if (success) {
            this.$q
              ...
              .onOk(() => {
                console.log("updatemedical", this.medicalstoreeditedItem);
                this.updatingAccMedicalStoreDetails(
                  this.medicalstoreeditedItem
                );
    ...
    openRestaurantDialog() {
      ...
      this.restaurantDetails.food_partner_sub_name =
        this.editedItem.partner_sub_name;
      this.restaurantDetails.partner_status = this.editedItem.status;
      this.restaurantDetails.date_to = this.editRestaurantDetails.date_to;
    ...
    editRestaurantData(item) {
      ...
      this.editRestaurantDetails.Name_Of_Contact_Person =
        item.Name_Of_Contact_Person;
      ...
      this.editRestaurantDetails.restaurant_longitude =
        item.restaurant_longitude;
      this.editRestaurantDetails.restaurant_description =
        item.restaurant_description;
      this.editRestaurantDetails.select_offer = item.select_offer;
      ...
      this.editRestaurantDetails.state = item.state_name;
      this.editRestaurantDetails.city = item.city_name;
