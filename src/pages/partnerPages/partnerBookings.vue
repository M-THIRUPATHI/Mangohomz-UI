    ...
    <q-page style="padding-top: 130px" class="q-pa-md">
      ...
      <!-- <template v-slot:header="props">
        <q-tr :props="props">
          <q-th auto-width />
          <q-th
            v-for="col in props.partner_bookings_columns"
...
export default {
  data() {
    return {
      ...
      bookingDialog: false,
      title: "Accommodation Booking Details of Customer",
      mode: "list",
      filter: "",
      addDataDialog: false,
      statesList: [],
  ...
  computed: {
    ...
    ...mapGetters("booking", ["partner_bookings_rows"]),
  },
  mounted() {
    this.$store.dispatch("booking/guestBookingData");
  },
  meta() {
    return {
      title: this.title,
