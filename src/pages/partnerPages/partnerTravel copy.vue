...
export default {
  ...
  methods: {
            ...
            if (this.editedItem.agent_id != "") {
              this.$q
                ...
                .onOk(() => {
                  ...
                  // console.log("FormDAta--", formData.get("pancard"));
                  // console.log("FormDAta--", formData.get("transportPartnerForm"));
          ...
          if (success) {
            this.$q
              ...
              .onOk(() => {
                ...
                // console.log("update", this.transportPartnerForm);
    ...
    submitTravelLocData(val) {
      // console.log("this.travelLocation", this.travelLocation);
      if (val == "submit") {
            ...
            if (success) {
              this.$q
                ...
                .onOk(() => {
                  ...
                  // console.log("saving", this.travelDetailsSaving);
        ...
        this.$refs.addTravelForm.validate().then((success) => {
          if (success) {
            this.$q
              ...
              .onOk(() => {
                // console.log("updating", this.travelLocation);
    ...
    editTravel(item) {
      ...
      // console.log("location", this.travelLocation);
      this.addTravelForm = true;
    },
    editOpenAddDialog() {
      this.step = 1;
    ...
    travelDetailsForm() {
      ...
      this.onclickValue = "";
      this.emptyValue();
      // console.log("travelForm", this.travelLocation);
      this.addTravelForm = true;
    },
    reset() {
