  ...
  <q-page-container>
    <q-page class=" flex justify-center bg-accent" style="padding-top:50px;">
      <q-card class="customer_signup-form q-pa-xl">
        <div class="text-h5 text-bold q-pa-md q-gutter-xs">
        ...
        <q-card-section class="q-pa-xs">
          ...
          >
            ...
            <q-input
              outlined
              dense
              v-model="patnerForm.mobile_no"
              label="Mobile No"
              lazy-rules
              mask="##########"
              :rules="[
                v => (v !== null && v !== '') || 'Please enter Mobile No',
                v =>
                  v == 0 ||
                  (v &&
                    !isNaN(parseFloat(v)) &&
...
export default {
  ...
  data() {
    return {
      ...
      usertype: "",
      options: ["Admin", "Customer", "Partner"],
      link: ""
    };
  },
  meta() {
    ...
    linkTo() {
      let link =
        this.usertype.toLowerCase() == "admin"
          ? "/admin" //condtion 1
          : this.usertype.toLowerCase() == "partner"
          ? "/partner" //condition 2
